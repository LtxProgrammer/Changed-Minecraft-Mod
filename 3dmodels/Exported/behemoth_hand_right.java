...
public class custom_model<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r11 = Thumb.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(42, 44).addBox(-5.5F, -4.5F, -2.25F, 11.0F, 9.0F, 9.0F, CubeDeformation.NONE)
		...
		PartDefinition cube_r12 = Thumb.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(56, 62).addBox(-5.0F, -4.3015F, -2.7899F, 5.0F, 9.0F, 9.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(5.0F, 1.0F, 1.0F, -0.3491F, 0.0F, 0.0F));
