...
public class custom_model<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head_r1 = RightEar.addOrReplaceChild("Head_r1", CubeListBuilder.create().texOffs(19, 20).addBox(-1.5F, -1.75F, -1.625F, 1.0F, 1.0F, 2.0F, CubeDeformation.NONE)
		.texOffs(21, 20).addBox(-1.5F, -0.75F, -1.625F, 1.0F, 3.0F, 3.0F, CubeDeformation.NONE)
		.texOffs(26, 19).addBox(-0.5F, -0.75F, -1.625F, 1.0F, 3.0F, 3.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(-0.5F, -1.375F, 0.5F, 0.0F, -1.5708F, -0.3927F));

		PartDefinition LeftEar = Head.addOrReplaceChild("LeftEar", CubeListBuilder.create(), PartPose.offset(2.5F, -7.0F, 0.0F));

		PartDefinition Head_r2 = LeftEar.addOrReplaceChild("Head_r2", CubeListBuilder.create().texOffs(4, 21).addBox(-0.5F, -0.75F, -1.625F, 1.0F, 3.0F, 3.0F, CubeDeformation.NONE)
		.texOffs(6, 22).addBox(0.5F, -1.75F, -1.625F, 1.0F, 1.0F, 2.0F, CubeDeformation.NONE)
		.texOffs(6, 18).addBox(0.5F, -0.75F, -1.625F, 1.0F, 3.0F, 3.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(1.0F, -1.375F, 0.5F, 0.0F, 1.5708F, 0.3927F));

		PartDefinition Hair = Head.addOrReplaceChild("Hair", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition Base_r1 = Hair.addOrReplaceChild("Base_r1", CubeListBuilder.create().texOffs(19, 21).addBox(-4.5F, -7.8F, -4.8F, 9.0F, 2.0F, 1.0F, CubeDeformation.NONE)
		.texOffs(19, 21).addBox(-4.5F, -6.0F, -4.8F, 1.0F, 7.0F, 2.0F, CubeDeformation.NONE)
		...
		.texOffs(22, 21).addBox(3.75F, -4.0F, 0.0F, 1.0F, 4.0F, 4.0F, CubeDeformation.NONE)
		.texOffs(24, 19).addBox(-4.75F, -4.0F, 0.0F, 1.0F, 4.0F, 4.0F, CubeDeformation.NONE)
		...
		.texOffs(17, 23).addBox(-4.0F, -0.75F, 2.0F, 8.0F, 1.0F, 2.0F, CubeDeformation.NONE)
		...
		PartDefinition Base_r2 = Tail.addOrReplaceChild("Base_r2", CubeListBuilder.create().texOffs(0, 48).addBox(-1.5F, 0.1914F, -1.4483F, 3.0F, 6.0F, 3.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 2.0F, 6.0F, 1.4835F, 0.0F, 0.0F));

		PartDefinition Base_r3 = Tail.addOrReplaceChild("Base_r3", CubeListBuilder.create().texOffs(16, 43).addBox(-1.5F, 0.0F, -1.0F, 3.0F, 7.0F, 3.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.1781F, 0.0F, 0.0F));
