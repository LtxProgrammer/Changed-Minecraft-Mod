...
public class custom_model<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head_r1 = Head.addOrReplaceChild("Head_r1", CubeListBuilder.create().texOffs(0, 44).addBox(-0.5F, -0.75F, -1.625F, 1.0F, 3.0F, 3.0F, CubeDeformation.NONE)
		.texOffs(1, 1).addBox(-1.5F, -1.75F, -1.625F, 1.0F, 1.0F, 2.0F, CubeDeformation.NONE)
		.texOffs(0, 0).addBox(-1.5F, -0.75F, -1.625F, 1.0F, 3.0F, 3.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(-3.5F, -8.375F, 0.5F, 0.0F, -1.5708F, -0.3927F));

		PartDefinition Head_r2 = Head.addOrReplaceChild("Head_r2", CubeListBuilder.create().texOffs(59, 46).addBox(-0.5F, -0.75F, -1.625F, 1.0F, 3.0F, 3.0F, CubeDeformation.NONE)
		.texOffs(43, 32).addBox(0.5F, -1.75F, -1.625F, 1.0F, 1.0F, 2.0F, CubeDeformation.NONE)
		.texOffs(42, 31).addBox(0.5F, -0.75F, -1.625F, 1.0F, 3.0F, 3.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(3.5F, -8.375F, 0.5F, 0.0F, 1.5708F, 0.3927F));
		...
		PartDefinition Base_r2 = Tail.addOrReplaceChild("Base_r2", CubeListBuilder.create().texOffs(0, 59).addBox(-1.5F, 0.1914F, -1.4483F, 3.0F, 6.0F, 3.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 2.0F, 6.0F, 1.4835F, 0.0F, 0.0F));
