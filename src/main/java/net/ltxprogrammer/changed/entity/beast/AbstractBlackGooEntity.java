...
import net.ltxprogrammer.changed.entity.ai.ChangedFollowOwnerGoal;
...
public abstract class AbstractBlackGooEntity extends AbstractGooWolf implements DarkLatexEntity, TamableLatexEntity {
    protected static final EntityDataAccessor<Byte> DATA_FLAGS_ID = SynchedEntityData.defineId(AbstractBlackGooEntity.class, EntityDataSerializers.BYTE);
    protected static final EntityDataAccessor<Optional<UUID>> DATA_OWNERUUID_ID = SynchedEntityData.defineId(AbstractBlackGooEntity.class, EntityDataSerializers.OPTIONAL_UUID);

    public AbstractBlackGooEntity(EntityType<? extends AbstractGooWolf> p_19870_, Level p_19871_) {
    ...
    protected void registerGoals() {
        super.registerGoals();
        this.goalSelector.addGoal(6, new ChangedFollowOwnerGoal<>(this, 0.35D, 10.0F, 2.0F, false));
    }
