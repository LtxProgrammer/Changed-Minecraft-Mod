...
public class GooPurpleFox extends AbstractGooWolf implements PowderSnowWalkable, PatronOC {
    public GooPurpleFox(EntityType<? extends GooPurpleFox> p_19870_, Level p_19871_) {
