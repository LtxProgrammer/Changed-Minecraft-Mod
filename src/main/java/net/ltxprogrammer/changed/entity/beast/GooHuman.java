...
public class GooHuman extends ChangedEntity {
    protected static final EntityDataAccessor<Optional<UUID>> DATA_PLAYER = SynchedEntityData.defineId(GooHuman.class, EntityDataSerializers.OPTIONAL_UUID);

    public GooHuman(EntityType<? extends GooHuman> p_19870_, Level p_19871_) {
    ...
    public void onReplicateOther(IAbstractChangedEntity other, TransfurVariant<?> variant) {
        ...
        if (variant == TransfurVariant.GOO_HUMAN) {
            if (other.getLatexEntity() instanceof GooHuman human) {
