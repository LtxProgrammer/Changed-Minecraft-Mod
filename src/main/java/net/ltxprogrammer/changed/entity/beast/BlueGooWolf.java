...
public class BlueGooWolf extends AbstractWhiteGooWolf implements PowderSnowWalkable {
    public BlueGooWolf(EntityType<? extends BlueGooWolf> p_19870_, Level p_19871_) {
