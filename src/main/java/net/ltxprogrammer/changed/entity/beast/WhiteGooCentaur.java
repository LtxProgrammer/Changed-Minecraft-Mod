...
public class WhiteGooCentaur extends WhiteGooKnight implements LatexTaur<WhiteGooCentaur> {
    public WhiteGooCentaur(EntityType<? extends WhiteGooCentaur> p_19870_, Level p_19871_) {
