...
public class GooStiger extends ChangedEntity {
    private static final EntityDataAccessor<Byte> DATA_FLAGS_ID = SynchedEntityData.defineId(GooStiger.class, EntityDataSerializers.BYTE);
    public GooStiger(EntityType<? extends GooStiger> p_19870_, Level p_19871_) {
