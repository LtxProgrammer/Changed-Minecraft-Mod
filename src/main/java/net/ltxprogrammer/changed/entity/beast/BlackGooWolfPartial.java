...
public class BlackGooWolfPartial extends AbstractBlackGooEntity {
    public BlackGooWolfPartial(EntityType<? extends BlackGooWolfPartial> p_19870_, Level p_19871_) {
