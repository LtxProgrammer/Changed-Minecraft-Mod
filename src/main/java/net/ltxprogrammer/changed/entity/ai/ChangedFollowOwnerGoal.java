...
public class ChangedFollowOwnerGoal<T extends ChangedEntity & TamableLatexEntity> extends Goal {
    ...
    public ChangedFollowOwnerGoal(T entity, double speed, float startDistance, float stopDistance, boolean canFly) {
        this.tamable = entity;
