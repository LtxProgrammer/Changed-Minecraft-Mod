...
public class LandFollowOwnerGoal<T extends ChangedEntity & TamableLatexEntity> extends Goal {
    ...
    public LandFollowOwnerGoal(T entity, double speed, float startDistance, float stopDistance, boolean canFly) {
        this.tamable = entity;
