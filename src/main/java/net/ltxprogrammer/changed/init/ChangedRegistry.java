...
public abstract class ChangedRegistry<T> implements Registry<T> {
    ...
    public static final RegistryHolder<TamedEntityFavor> TAMED_ENTITY_FAVORS = new RegistryHolder<>(registryKey("tamed_entity_favors"));
    ...
    public static void onCreateRegistries(NewRegistryEvent event) {
        ...
        createRegistry(event, TAMED_ENTITY_FAVORS.key);
