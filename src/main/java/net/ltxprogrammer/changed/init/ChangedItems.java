...
public class ChangedItems {
    ...
    public static final RegistryObject<AbstractLatexBucket> AEROSOL_LATEX_BUCKET = register("aerosol_latex_bucket", AbstractLatexBucket.from(ChangedFluids.AEROSOL_LATEX));
