...
public class ChangedBlocks {
    ...
    public static final RegistryObject<IronCrate> IRON_CRATE = register("iron_crate", () -> new IronCrate(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.COLOR_GRAY).sound(SoundType.COPPER).strength(5.0F, 40.0F)));
    ...
    public static final RegistryObject<LabTable2x1> LAB_TABLE_2X1 = register("lab_table_2x1", () -> new LabTable2x1(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.COLOR_BLACK).sound(SoundType.METAL).strength(3.0F, 18.0F)));
    ...
    public static final RegistryObject<LabBlock> TILES_GREENHOUSE = register("tiles_greenhouse", () -> new LabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).sound(SoundType.WOOD).strength(1.5F, 6.0F)));
    public static final RegistryObject<LabBlock> WALL_GREENHOUSE = register("wall_greenhouse", () -> new LabBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).sound(SoundType.WOOD).strength(1.5F, 6.0F)));
    ...
    public static final RegistryObject<LabBlock> TILES_WHITE_CONNECTED = register("tiles_white_connected", () -> new LabBlock(BlockBehaviour.Properties.copy(TILES_WHITE.get())));
