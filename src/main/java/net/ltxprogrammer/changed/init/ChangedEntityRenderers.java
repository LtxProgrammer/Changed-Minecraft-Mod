...
public class ChangedEntityRenderers {
    private static Map<String, EntityRenderer<? extends BlackGooWolfPartial>> partialRenderers = ImmutableMap.of();
    private static Map<String, EntityRenderer<? extends GooHuman>> humanRenderers = ImmutableMap.of();

    @Nullable
    public static <T extends Entity> EntityRenderer<? super T> getRenderer(T entity) {
        if (entity instanceof BlackGooWolfPartial partial) {
            String s = partial.getModelName();
            EntityRenderer<? extends BlackGooWolfPartial> entityrenderer = partialRenderers.get(s);
            return (EntityRenderer) (entityrenderer != null ? entityrenderer : partialRenderers.get("default"));
        } else if (entity instanceof GooHuman human) {
            String s = human.getModelName();
            EntityRenderer<? extends GooHuman> entityrenderer = humanRenderers.get(s);
    ...
    public static void registerComplexRenderers(EntityRendererProvider.Context context) {
        partialRenderers = new ImmutableMap.Builder<String, EntityRenderer<? extends BlackGooWolfPartial>>()
                .put("default", new DarkLatexWolfPartialRenderer(context, false))
                .put("slim", new DarkLatexWolfPartialRenderer(context, true)).build();
        humanRenderers = new ImmutableMap.Builder<String, EntityRenderer<? extends GooHuman>>()
    ...
    public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(ChangedEntities.GOO_ALIEN.get(), GooAlienRenderer::new);
        event.registerEntityRenderer(ChangedEntities.GOO_BEE.get(), GooBeeRenderer::new);
        event.registerEntityRenderer(ChangedEntities.BEIFENG.get(), BeifengRenderer::new);
        ...
        event.registerEntityRenderer(ChangedEntities.GOO_ORCA.get(), GooOrcaRenderer::new);
        ...
        event.registerEntityRenderer(ChangedEntities.GOO_SHARK.get(), GooSharkRenderer::new);
        ...
        event.registerEntityRenderer(ChangedEntities.GOO_SNAKE.get(), GooSnakeRenderer::new);
        event.registerEntityRenderer(ChangedEntities.LATEX_SNIPER_DOG.get(), LatexSniperDogRenderer::new);
        event.registerEntityRenderer(ChangedEntities.GOO_SNOW_LEOPARD_FEMALE.get(), GooSnowLeopardFemaleRenderer::new);
        event.registerEntityRenderer(ChangedEntities.GOO_SNOW_LEOPARD_MALE.get(), GooSnowLeopardMaleRenderer::new);
        event.registerEntityRenderer(ChangedEntities.GOO_SQUID_DOG_FEMALE.get(), GooSquidDogFemaleRenderer::new);
        event.registerEntityRenderer(ChangedEntities.GOO_SQUID_DOG_MALE.get(), GooSquidDogMaleRenderer::new);
        event.registerEntityRenderer(ChangedEntities.GOO_SQUIRREL.get(), GooSquirrelRenderer::new);
        event.registerEntityRenderer(ChangedEntities.GOO_STIGER.get(), GooStigerRenderer::new);
        event.registerEntityRenderer(ChangedEntities.GOO_TIGER_SHARK.get(), GooTigerSharkRenderer::new);
