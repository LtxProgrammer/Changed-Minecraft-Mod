...
public class ChangedTransfurVariantFeatures {
    ...
    public static final RegistryObject<TransfurVariantFeature> ABSORPTION = REGISTRY.register("grab/absorption", TransfurVariantFeature::maxPresent);
    ...
    public static final RegistryObject<TransfurVariantFeature> BREATHE_DENY_AIR = REGISTRY.register("breathe/deny_air", TransfurVariantFeature::binary);
    public static final RegistryObject<TransfurVariantFeature> BREATHE_ACCEPT_WATER = REGISTRY.register("breathe/accept_water", TransfurVariantFeature::maxPresent);
}
