...
public class ChangedGameRules {
    ...
    public static final GameRules.Key<GameRules.BooleanValue> RULE_DO_PALE = register("changed:doPale", GameRules.Category.UPDATES, GameRules.BooleanValue.create(true));
