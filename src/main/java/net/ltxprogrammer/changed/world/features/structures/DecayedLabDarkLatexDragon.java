...
public class DecayedLabDarkLatexDragon extends Feature<NoneFeatureConfiguration> {
    public static DecayedLabDarkLatexDragon FEATURE = null;
    public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
    public static Holder<PlacedFeature> PLACED_FEATURE = null;

    public static Feature<?> feature() {
        if (FEATURE == null) {
            FEATURE = new DecayedLabDarkLatexDragon();
    ...
    public DecayedLabDarkLatexDragon() {
