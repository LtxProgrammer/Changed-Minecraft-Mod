...
public class GooDripParticle extends TextureSheetParticle {
    private boolean lastOnGround = false;

    protected GooDripParticle(ClientLevel level, double x, double y, double z, double vx, double vy, double vz, SpriteSet sprite, Color3 color) {
    ...
    public static class Provider implements ParticleProvider<ColoredParticleOption> {
        ...
        public Particle createParticle(ColoredParticleOption type, ClientLevel level, double x, double y, double z,
            ...
            return new GooDripParticle(level, x, y, z, xSpeed, ySpeed, zSpeed, sprite, type.getColor());
        }
    }
}