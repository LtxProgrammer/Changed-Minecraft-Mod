...
@OnlyIn(Dist.CLIENT)
public class DarkLatexWolfMaleModel extends AdvancedHumanoidModel<DarkLatexWolfMale> implements AdvancedHumanoidModelInterface<DarkLatexWolfMale, DarkLatexWolfMaleModel> {
    ...
    @Override
    public HumanoidAnimator<DarkLatexWolfMale, DarkLatexWolfMaleModel> getAnimator() {
        return animator;
    }
}