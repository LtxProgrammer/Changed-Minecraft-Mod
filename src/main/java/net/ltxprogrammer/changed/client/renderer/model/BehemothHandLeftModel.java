...
public class BehemothHandLeftModel extends EntityModel<BehemothHandLeft> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition cube_r1 = Hand.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 43).addBox(-10.0F, -15.0F, 3.5F, 20.0F, 15.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(54, 33).addBox(3.0F, -1.5F, -5.5F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(54, 35).addBox(-8.0F, -1.5F, -5.5F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(54, 40).addBox(-4.0F, -11.5F, -5.5F, 9.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(54, 38).addBox(-5.0F, -9.5F, -5.5F, 11.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(68, 20).addBox(-7.0F, -8.5F, -5.5F, 15.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(48, 0).addBox(-8.0F, -7.5F, -5.5F, 17.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition cube_r3 = Pinkie.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 59).addBox(4.0F, -8.2143F, -1.9557F, 6.0F, 10.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-7.0F, -3.25F, -0.5F, 0.3491F, 0.0F, 0.0F));
        ...
        PartDefinition cube_r6 = Middle.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(28, 61).addBox(-3.0F, -8.2143F, -1.9557F, 6.0F, 10.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.25F, -0.5F, 0.3491F, 0.0F, 0.0F));

        PartDefinition cube_r7 = Middle.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(69, 25).addBox(-11.0F, -21.125F, -3.7F, 6.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.0F, 14.75F, -5.5F, -0.3491F, 0.0F, 0.0F));
        ...
        PartDefinition cube_r9 = Index.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(56, 61).addBox(-10.0F, -8.2143F, -1.9557F, 6.0F, 10.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(7.0F, -3.25F, -0.5F, 0.3491F, 0.0F, 0.0F));

        PartDefinition cube_r10 = Index.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(73, 38).addBox(-10.0F, -21.125F, -3.7F, 6.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(7.0F, 14.75F, -5.5F, -0.3491F, 0.0F, 0.0F));
