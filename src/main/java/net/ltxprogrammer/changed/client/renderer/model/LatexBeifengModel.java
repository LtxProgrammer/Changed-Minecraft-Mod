...
public class LatexBeifengModel extends LatexHumanoidModel<LatexBeifeng> implements LatexHumanoidModelInterface {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Hair = Head.addOrReplaceChild("Hair", CubeListBuilder.create().texOffs(51, 15).addBox(-2.0F, -35.0F, -4.0F, 4.0F, 1.0F, 8.0F, CubeDeformation.NONE)
                ...
                .texOffs(66, 0).addBox(-4.0F, -34.0F, 4.0F, 8.0F, 6.0F, 1.0F, CubeDeformation.NONE), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition Base_r11 = RightArm.addOrReplaceChild("Base_r11", CubeListBuilder.create().texOffs(52, 0).addBox(-2.7F, 0.15F, 5.0F, 1.0F, 4.0F, 1.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(-4.0F, -24.0F, 0.0F, -0.5672F, -0.5672F, 0.0F));

        PartDefinition Spike_r1 = RightArm.addOrReplaceChild("Spike_r1", CubeListBuilder.create().texOffs(52, 6).addBox(-2.8F, -5.0F, 1.1F, 1.0F, 4.0F, 1.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(-4.0F, -24.0F, 0.0F, -0.3491F, -0.3054F, -0.2618F));
        ...
        PartDefinition Spike_r2 = LeftArm.addOrReplaceChild("Spike_r2", CubeListBuilder.create().texOffs(48, 6).addBox(1.8F, -5.0F, 1.1F, 1.0F, 4.0F, 1.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(4.0F, -24.0F, 0.0F, -0.3491F, 0.3054F, 0.2618F));

        PartDefinition Base_r12 = LeftArm.addOrReplaceChild("Base_r12", CubeListBuilder.create().texOffs(48, 0).addBox(1.7F, 0.15F, 5.0F, 1.0F, 4.0F, 1.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(4.0F, -24.0F, 0.0F, -0.5672F, 0.5672F, 0.0F));
