...
public class LatexSquirrelModel extends AdvancedHumanoidModel<LatexSquirrel> implements AdvancedHumanoidModelInterface<LatexSquirrel, LatexSquirrelModel> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition TailPrimary = Tail.addOrReplaceChild("TailPrimary", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -0.4F, 0.25F, 0.2182F, 0.0F, 0.0F));

        PartDefinition Base_r1 = TailPrimary.addOrReplaceChild("Base_r1", CubeListBuilder.create().texOffs(37, 0).addBox(-2.0F, 1.0F, -1.5F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(0.0F, 1.8F, 1.85F, 1.309F, 0.0F, 0.0F));

        PartDefinition Base_r2 = TailPrimary.addOrReplaceChild("Base_r2", CubeListBuilder.create().texOffs(0, 59).addBox(-2.0F, 0.0F, -1.0F, 4.0F, 4.0F, 3.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 0.4F, -0.25F, 0.9163F, 0.0F, 0.0F));

        PartDefinition TailSecondary = TailPrimary.addOrReplaceChild("TailSecondary", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 2.8F, 5.05F, -0.3491F, 0.0F, 0.0F));

        PartDefinition Base_r3 = TailSecondary.addOrReplaceChild("Base_r3", CubeListBuilder.create().texOffs(65, 39).addBox(-2.5F, -1.0F, -1.5F, 5.0F, 4.0F, 4.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0F, 0.2F, 1.2F, 1.789F, 0.0F, 0.0F));

        PartDefinition TailTertiary = TailSecondary.addOrReplaceChild("TailTertiary", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -0.3F, 2.5F, -0.6545F, 0.0F, 0.0F));

        PartDefinition Base_r4 = TailTertiary.addOrReplaceChild("Base_r4", CubeListBuilder.create().texOffs(56, 10).addBox(-3.5F, 3.0F, -2.5F, 7.0F, 5.0F, 5.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0F, 2.35F, -1.7F, 2.5307F, 0.0F, 0.0F));

        PartDefinition TailQuaternary = TailTertiary.addOrReplaceChild("TailQuaternary", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -1.7F, 1.6F, -0.4363F, 0.0F, 0.0F));

        PartDefinition Base_r5 = TailQuaternary.addOrReplaceChild("Base_r5", CubeListBuilder.create().texOffs(57, 26).addBox(-4.5F, -1.0F, -2.5F, 9.0F, 6.0F, 7.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0F, -0.75F, 1.05F, 2.9671F, 0.0F, 0.0F));

        PartDefinition TailQuinary = TailQuaternary.addOrReplaceChild("TailQuinary", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -4.3F, 0.6F, -0.3054F, 0.0F, 0.0F));

        PartDefinition Base_r6 = TailQuinary.addOrReplaceChild("Base_r6", CubeListBuilder.create().texOffs(29, 74).addBox(-4.5F, 1.0F, -2.5F, 9.0F, 5.0F, 7.0F, new CubeDeformation(0.3F)), PartPose.offsetAndRotation(0.0F, -4.9F, 0.1F, -3.098F, 0.0F, 0.0F));

        PartDefinition Base_r7 = TailQuinary.addOrReplaceChild("Base_r7", CubeListBuilder.create().texOffs(0, 66).addBox(-5.0F, 0.0F, -2.5F, 10.0F, 6.0F, 8.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0F, -0.45F, 1.6F, -2.9671F, 0.0F, 0.0F));
        ...
        PartDefinition Base_r8 = TailSenary.addOrReplaceChild("Base_r8", CubeListBuilder.create().texOffs(0, 80).addBox(-4.5F, 2.0F, -2.5F, 9.0F, 4.0F, 7.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 2.05F, 0.5F, 2.9671F, 0.0F, 0.0F));
        ...
        PartDefinition Base_r9 = TailSeptenary.addOrReplaceChild("Base_r9", CubeListBuilder.create().texOffs(28, 64).addBox(-4.0F, 3.95F, -2.5F, 8.0F, 4.0F, 6.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0F, 3.4F, -1.8F, 2.4871F, 0.0F, 0.0F));
        ...
        PartDefinition Base_r10 = TailOctonary.addOrReplaceChild("Base_r10", CubeListBuilder.create().texOffs(48, 0).addBox(-4.0F, 3.0F, -2.5F, 8.0F, 4.0F, 6.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(0.0F, 1.9F, -2.7F, 2.0071F, 0.0F, 0.0F));
