...
public class GooSquidDogFemaleModel extends AdvancedHumanoidModel<GooSquidDogFemale> implements AdvancedHumanoidModelInterface<GooSquidDogFemale, GooSquidDogFemaleModel>, DoubleArmedModel {
    ...
    private final HumanoidAnimator<GooSquidDogFemale, GooSquidDogFemaleModel> animator;

    public GooSquidDogFemaleModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(GooSquidDogFemale p_102861_, float p_102862_, float p_102863_, float p_102864_) {
        this.prepareMobModel(animator, p_102861_, p_102862_, p_102863_, p_102864_);
    }

    @Override
    public void setupAnim(GooSquidDogFemale entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float HeadPitch) {
    ...
    @Override
    public HumanoidAnimator<GooSquidDogFemale, GooSquidDogFemaleModel> getAnimator() {
        return animator;
    }
