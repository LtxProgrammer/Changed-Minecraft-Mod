...
public class GooParticlesLayer<T extends ChangedEntity, M extends AdvancedHumanoidModel<T>> extends RenderLayer<T, M> {
    ...
    public GooParticlesLayer(RenderLayerParent<T, M> parent, M model) {
        this(parent, model, GooParticlesLayer::always);
    }

    public GooParticlesLayer(RenderLayerParent<T, M> parent, M model, LatexTranslucentLayer<T, M> translucentLayer) {
        this(parent, model, translucentLayer, GooParticlesLayer::always);
    }

    public GooParticlesLayer(RenderLayerParent<T, M> parent, M model, Predicate<ModelPart> canPartDrip) {
        super(parent);
        this.parent = parent;
        this.model = model;
    ...
    public GooParticlesLayer(RenderLayerParent<T, M> parent, M model, LatexTranslucentLayer<T, M> translucentLayer, Predicate<ModelPart> canPartDrip) {
        super(parent);
        this.parent = parent;
        this.model = model;
        this.minecraft = Minecraft.getInstance();
