...
@OnlyIn(Dist.CLIENT)
public class GooCrocodileModel extends AdvancedHumanoidModel<GooCrocodile> implements AdvancedHumanoidModelInterface<GooCrocodile, GooCrocodileModel> {
    ...
    private final HumanoidAnimator<GooCrocodile, GooCrocodileModel> animator;

    public GooCrocodileModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(GooCrocodile p_102861_, float p_102862_, float p_102863_, float p_102864_) {
    ...
    @Override
    public void setupAnim(@NotNull GooCrocodile entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<GooCrocodile, GooCrocodileModel> getAnimator() {
        return animator;
    }
}
