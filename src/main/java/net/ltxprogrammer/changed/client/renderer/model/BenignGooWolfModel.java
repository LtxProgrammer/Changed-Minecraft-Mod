...
public class BenignGooWolfModel extends AdvancedHumanoidModel<BenignGooWolf> implements AdvancedHumanoidModelInterface<BenignGooWolf, BenignGooWolfModel> {
    ...
    private final HumanoidAnimator<BenignGooWolf, BenignGooWolfModel> animator;

    public BenignGooWolfModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(BenignGooWolf p_102861_, float p_102862_, float p_102863_, float p_102864_) {
    ...
    @Override
    public void setupAnim(@NotNull BenignGooWolf entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<BenignGooWolf, BenignGooWolfModel> getAnimator() {
        return animator;
    }
}
