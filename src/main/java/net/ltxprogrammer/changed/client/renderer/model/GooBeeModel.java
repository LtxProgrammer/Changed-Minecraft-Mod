...
@OnlyIn(Dist.CLIENT)
public class GooBeeModel extends AdvancedHumanoidModel<GooBee> implements AdvancedHumanoidModelInterface<GooBee, GooBeeModel>, DoubleArmedModel {
    ...
    private final HumanoidAnimator<GooBee, GooBeeModel> animator;

    public GooBeeModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(GooBee p_102861_, float p_102862_, float p_102863_, float p_102864_) {
    ...
    @Override
    public HumanoidAnimator<GooBee, GooBeeModel> getAnimator() {
        return animator;
    }
}