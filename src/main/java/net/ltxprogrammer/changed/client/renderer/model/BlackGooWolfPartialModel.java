...
@OnlyIn(Dist.CLIENT)
public class BlackGooWolfPartialModel extends AdvancedHumanoidModel<BlackGooWolfPartial> implements AdvancedHumanoidModelInterface<BlackGooWolfPartial, BlackGooWolfPartialModel> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION_GOO = new ModelLayerLocation(Changed.modResource("dark_latex_wolf_partial"), "latex");
    public static final ModelLayerLocation LAYER_LOCATION_GOO_SLIM = new ModelLayerLocation(Changed.modResource("dark_latex_wolf_partial"), "latex_slim");
    ...
    private final HumanoidAnimator<BlackGooWolfPartial, BlackGooWolfPartialModel> animator;

    private static final ModelPart NULL_PART = new ModelPart(List.of(), Map.of());

    public BlackGooWolfPartialModel(ModelPart root, boolean latexLayer) {
        super(root);
    ...
    public static BlackGooWolfPartialModel human(ModelPart root) {
        return new BlackGooWolfPartialModel(root, false);
    }

    public static BlackGooWolfPartialModel latex(ModelPart root) {
        return new BlackGooWolfPartialModel(root, true);
    }
    ...
    public static LayerDefinition createGooLayer(boolean slim) {
        float armWidth = slim ? 3.0f : 4.0f;
        float rightArmOffset = slim ? 1.0f : 0.0f;
    ...
    @Override
    public void prepareMobModel(BlackGooWolfPartial p_102861_, float p_102862_, float p_102863_, float p_102864_) {
    ...
    @Override
    public void setupAnim(@NotNull BlackGooWolfPartial entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<BlackGooWolfPartial, BlackGooWolfPartialModel> getAnimator() {
        return animator;
    }
}