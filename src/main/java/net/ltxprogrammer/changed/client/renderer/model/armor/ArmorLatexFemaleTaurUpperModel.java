...
public class ArmorLatexFemaleTaurUpperModel<T extends ChangedEntity> extends LatexHumanoidArmorModel<T, ArmorLatexFemaleTaurUpperModel<T>> {
    public static final ArmorModelSet<ChangedEntity, ArmorLatexFemaleTaurUpperModel<ChangedEntity>> MODEL_SET =
            ArmorModelSet.of(Changed.modResource("armor_latex_female_taur_upper"), ArmorLatexFemaleTaurUpperModel::createArmorLayer, ArmorLatexFemaleTaurUpperModel::new);

    private final ModelPart RightArm;
    private final ModelPart LeftArm;
    private final ModelPart Head;
    private final ModelPart Torso;
    private final HumanoidAnimator<T, ArmorLatexFemaleTaurUpperModel<T>> animator;

    public ArmorLatexFemaleTaurUpperModel(ModelPart modelPart, ArmorModel model) {
    ...
    @Override
    public HumanoidAnimator<T, ArmorLatexFemaleTaurUpperModel<T>> getAnimator(T entity) {
        return animator;
    }
