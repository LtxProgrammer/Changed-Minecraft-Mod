...
public class GooYuinModel extends AdvancedHumanoidModel<GooYuin> implements AdvancedHumanoidModelInterface<GooYuin, GooYuinModel> {
    ...
    private final HumanoidAnimator<GooYuin, GooYuinModel> animator;

    public GooYuinModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(GooYuin p_102861_, float p_102862_, float p_102863_, float p_102864_) {
    ...
    @Override
    public void setupAnim(@NotNull GooYuin entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<GooYuin, GooYuinModel> getAnimator() {
        return animator;
    }
}
