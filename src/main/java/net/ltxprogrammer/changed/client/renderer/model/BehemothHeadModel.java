...
public class BehemothHeadModel extends EntityModel<BehemothHead> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Changed.modResource("behemoth_head"), "main");
    private final ModelPart Head;

    public BehemothHeadModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(BehemothHead entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
