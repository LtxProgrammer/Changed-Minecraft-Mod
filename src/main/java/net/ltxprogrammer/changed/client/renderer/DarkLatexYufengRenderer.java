...
import net.ltxprogrammer.changed.client.renderer.model.BlackGooYufengModel;
...
public class DarkLatexYufengRenderer extends AdvancedHumanoidRenderer<BlackGooYufeng, BlackGooYufengModel, ArmorLatexMaleWingedDragonModel<BlackGooYufeng>> {
    public DarkLatexYufengRenderer(EntityRendererProvider.Context context) {
        super(context, new BlackGooYufengModel(context.bakeLayer(BlackGooYufengModel.LAYER_LOCATION)),
    ...
    @Override
    public ResourceLocation getTextureLocation(BlackGooYufeng p_114482_) {
