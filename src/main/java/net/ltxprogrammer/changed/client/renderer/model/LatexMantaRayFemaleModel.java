...
public class LatexMantaRayFemaleModel extends LatexHumanoidModel<LatexMantaRayFemale> implements LatexHumanoidModelInterface {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Base_r6 = Joint2.addOrReplaceChild("Base_r6", CubeListBuilder.create().texOffs(63, 52).addBox(-0.5F, -29.2462F, 19.6296F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(20, 63).addBox(-0.5F, -27.2462F, 22.6296F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(53, 19).addBox(-1.0F, -27.2462F, 19.6296F, 2.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -22.3593F, -3.8194F, -2.1555F, 0.0F, 0.0F));
