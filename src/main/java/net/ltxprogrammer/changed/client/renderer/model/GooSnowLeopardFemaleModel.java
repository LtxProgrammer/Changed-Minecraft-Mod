...
public class GooSnowLeopardFemaleModel extends AdvancedHumanoidModel<GooSnowLeopardFemale> implements AdvancedHumanoidModelInterface<GooSnowLeopardFemale, GooSnowLeopardFemaleModel> {
    ...
    private final HumanoidAnimator<GooSnowLeopardFemale, GooSnowLeopardFemaleModel> animator;

    public GooSnowLeopardFemaleModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(GooSnowLeopardFemale p_102861_, float p_102862_, float p_102863_, float p_102864_) {
    ...
    @Override
    public void setupAnim(@NotNull GooSnowLeopardFemale entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<GooSnowLeopardFemale, GooSnowLeopardFemaleModel> getAnimator() {
        return animator;
    }
}
