...
public class ArmorLatexOtterModel<T extends LatexEntity> extends LatexHumanoidArmorModel<T> {
    ...
    public static LayerDefinition createArmorLayer(ArmorModel layer) {
        ...
        PartDefinition quaternarytailsegment_r1 = Tail.addOrReplaceChild("quaternarytailsegment_r1", CubeListBuilder.create().texOffs(0, 20).addBox(-1.5F, 16.5F, -5.3F, 3.0F, 5.0F, 3.0F, layer.deformation.extend(0.6F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.5272F, 0.0F, 0.0F));

        PartDefinition tertiarytailsegment_r1 = Tail.addOrReplaceChild("tertiarytailsegment_r1", CubeListBuilder.create().texOffs(0, 20).addBox(-1.5F, 10.5F, -3.9F, 3.0F, 6.0F, 3.0F, layer.deformation.extend(0.9F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.4399F, 0.0F, 0.0F));

        PartDefinition secondarytailsegment_r1 = Tail.addOrReplaceChild("secondarytailsegment_r1", CubeListBuilder.create().texOffs(0, 20).addBox(-2.0F, 6.0F, -1.65F, 4.0F, 5.0F, 4.0F, layer.deformation.extend(0.9F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.1781F, 0.0F, 0.0F));

        PartDefinition primarytailsegment_r1 = Tail.addOrReplaceChild("primarytailsegment_r1", CubeListBuilder.create().texOffs(0, 20).addBox(-2.0F, 0.75F, -0.85F, 4.0F, 5.0F, 4.0F, layer.deformation.extend(1.2F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.0472F, 0.0F, 0.0F));
