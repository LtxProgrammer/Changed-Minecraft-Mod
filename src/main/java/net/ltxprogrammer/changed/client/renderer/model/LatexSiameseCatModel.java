...
public class LatexSiameseCatModel extends AdvancedHumanoidModel<LatexSiameseCat> implements AdvancedHumanoidModelInterface<LatexSiameseCat, LatexSiameseCatModel> {
    ...
    @Override
    public void prepareMobModel(LatexSiameseCat p_102861_, float p_102862_, float p_102863_, float p_102864_) {
    ...
    @Override
    public void setupAnim(@NotNull LatexSiameseCat entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
