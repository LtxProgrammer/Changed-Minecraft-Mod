...
public class ArmorLightLatexCentaurModel extends LatexHumanoidArmorModel<WhiteLatexCentaur, ArmorLightLatexCentaurModel> implements LowerTorsoedModel {
    ...
    public static LayerDefinition createArmorLayer(ArmorModel layer) {
        ...
        PartDefinition Base_r1 = Tail.addOrReplaceChild("Base_r1", CubeListBuilder.create().texOffs(2, 17).addBox(-1.5F, 2.1914F, -2.1983F, 3.0F, 7.0F, 3.0F, layer.slightAltDeformation), PartPose.offsetAndRotation(0.0F, 2.0F, 5.0F, 1.4835F, 0.0F, 0.0F));
    ...
    @Override
    public HumanoidAnimator<WhiteLatexCentaur, ArmorLightLatexCentaurModel> getAnimator() {
        return animator;
    }
