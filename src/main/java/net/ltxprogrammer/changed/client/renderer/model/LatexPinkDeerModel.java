...
@OnlyIn(Dist.CLIENT)
public class LatexPinkDeerModel extends LatexHumanoidModel<LatexPinkDeer> implements LatexHumanoidModelInterface {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, CubeDeformation.NONE)
                .texOffs(61, 35).addBox(-2.0F, -3.0F, -6.0F, 4.0F, 2.0F, 2.0F, CubeDeformation.NONE)
                .texOffs(20, 16).addBox(-1.5F, -1.0F, -5.0F, 3.0F, 1.0F, 1.0F, CubeDeformation.NONE), PartPose.offset(0.0F, -1.0F, 0.0F));
        ...
        PartDefinition Antler_r1 = Head.addOrReplaceChild("Antler_r1", CubeListBuilder.create().texOffs(66, 46).addBox(1.0F, -38.0F, 4.75F, 1.0F, 6.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(50, 41).addBox(1.0F, -35.0F, 3.75F, 1.0F, 2.0F, 1.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 25.0F, 0.0F, 0.1745F, -0.0873F, -0.1309F));

        PartDefinition Antler_r2 = Head.addOrReplaceChild("Antler_r2", CubeListBuilder.create().texOffs(62, 48).addBox(1.0F, -37.5F, -10.25F, 1.0F, 4.0F, 1.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 25.0F, 0.0F, -0.2618F, -0.0873F, -0.1309F));

        PartDefinition Antler_r3 = Head.addOrReplaceChild("Antler_r3", CubeListBuilder.create().texOffs(54, 39).addBox(1.0F, -34.5F, 9.0F, 1.0F, 4.0F, 1.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 25.0F, 0.0F, 0.3491F, -0.0873F, -0.1309F));
        ...
        PartDefinition Antler_r4 = Head.addOrReplaceChild("Antler_r4", CubeListBuilder.create().texOffs(66, 46).addBox(-2.0F, -38.0F, 4.75F, 1.0F, 6.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(50, 41).addBox(-2.0F, -35.0F, 3.75F, 1.0F, 2.0F, 1.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 25.0F, 0.0F, 0.1745F, 0.0873F, 0.1309F));

        PartDefinition Antler_r5 = Head.addOrReplaceChild("Antler_r5", CubeListBuilder.create().texOffs(54, 39).addBox(-2.0F, -37.5F, -10.25F, 1.0F, 4.0F, 1.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 25.0F, 0.0F, -0.2618F, 0.0873F, 0.1309F));

        PartDefinition Antler_r6 = Head.addOrReplaceChild("Antler_r6", CubeListBuilder.create().texOffs(62, 48).addBox(-2.0F, -34.5F, 9.0F, 1.0F, 4.0F, 1.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 25.0F, 0.0F, 0.3491F, 0.0873F, 0.1309F));

        PartDefinition Horn_r1 = Head.addOrReplaceChild("Horn_r1", CubeListBuilder.create().texOffs(31, 54).addBox(2.0F, -19.65F, 20.75F, 1.0F, 1.0F, 5.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 25.0F, 1.0F, 0.7418F, 0.6109F, 0.0F));
        ...
        PartDefinition Horn_r4 = Head.addOrReplaceChild("Horn_r4", CubeListBuilder.create().texOffs(31, 54).addBox(-3.0F, -19.65F, 20.75F, 1.0F, 1.0F, 5.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 25.0F, 0.0F, 0.7418F, -0.6109F, 0.0F));
        ...
        PartDefinition Hair = Head.addOrReplaceChild("Hair", CubeListBuilder.create().texOffs(60, 10).addBox(-2.0F, -34.9F, -4.0F, 4.0F, 1.0F, 8.0F, CubeDeformation.NONE)
                ...
                .texOffs(74, 0).addBox(-4.0F, -34.0F, 4.0F, 8.0F, 7.0F, 1.0F, CubeDeformation.NONE), PartPose.offset(0.0F, 26.0F, 0.0F));
        ...
        PartDefinition Torso = partdefinition.addOrReplaceChild("Torso", CubeListBuilder.create().texOffs(0, 16).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, CubeDeformation.NONE)
                .texOffs(61, 39).addBox(-2.0F, 2.0F, -2.75F, 4.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(26, 60).addBox(-3.0F, 2.0F, 1.5F, 6.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(59, 43).addBox(-3.0F, 0.0F, -2.75F, 6.0F, 2.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(60, 6).addBox(-3.0F, 3.0F, -2.5F, 6.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(44, 8).addBox(-4.0F, 0.0F, -2.5F, 8.0F, 3.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(51, 53).addBox(-4.0F, 0.0F, 1.5F, 8.0F, 2.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(58, 32).addBox(-3.0F, 0.0F, 1.75F, 6.0F, 2.0F, 1.0F, CubeDeformation.NONE), PartPose.offset(0.0F, -1.0F, 0.0F));

        PartDefinition LeftTuft_r1 = Torso.addOrReplaceChild("LeftTuft_r1", CubeListBuilder.create().texOffs(56, 20).addBox(-11.5F, -23.5F, -2.5F, 1.0F, 2.0F, 5.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 25.0F, 0.0F, 0.0F, 0.0F, 0.6109F));

        PartDefinition RightTuft_r1 = Torso.addOrReplaceChild("RightTuft_r1", CubeListBuilder.create().texOffs(54, 56).addBox(10.5F, -23.5F, -2.5F, 1.0F, 2.0F, 5.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 25.0F, 0.0F, 0.0F, 0.0F, -0.6109F));
        ...
        PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(24, 16).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, CubeDeformation.NONE)
