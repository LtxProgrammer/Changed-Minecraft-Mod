...
public class LatexTranslucentLizardModel extends LatexHumanoidModel<LatexTranslucentLizard> implements LatexHumanoidModelInterface {
    ...
    public static LayerDefinition createInnerLayer() {
        ...
        PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(24, 16).addBox(-3.0F, -6.0F, -3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.0F, 0.0F));

        PartDefinition Torso = partdefinition.addOrReplaceChild("Torso", CubeListBuilder.create().texOffs(32, 0).addBox(-3.0F, 2.25F, -1.5F, 6.0F, 9.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.0F, 0.0F));

        PartDefinition Tail = Torso.addOrReplaceChild("Tail", CubeListBuilder.create(), PartPose.offset(0.0F, 12.0F, 0.0F));

        PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, 6.75F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.2F)), PartPose.offset(-5.0F, 0.0F, 0.0F));

        PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(24, 0).addBox(0.0F, 6.75F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.2F)), PartPose.offset(5.0F, 0.0F, 0.0F));
    ...
    public static LayerDefinition createOuterLayer() {
        ...
        PartDefinition Gooeycenter_r1 = RightLeg.addOrReplaceChild("Gooeycenter_r1", CubeListBuilder.create().texOffs(28, 46).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2182F, 0.0F, 0.0F));
        ...
        PartDefinition Gooeycenter_r2 = LeftLeg.addOrReplaceChild("Gooeycenter_r2", CubeListBuilder.create().texOffs(44, 46).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2182F, 0.0F, 0.0F));

        PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -7.005F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(20, 28).addBox(-3.0F, -1.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(0, 34).addBox(0.0F, 10.85F, -2.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.01F))
                .texOffs(32, 30).addBox(-3.0F, 10.85F, 1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.01F))
                .texOffs(32, 28).addBox(-3.0F, 10.85F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.01F))
                .texOffs(16, 32).addBox(-3.0F, 10.85F, -2.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.01F)), PartPose.offset(-5.0F, 0.0F, 0.0F));
        ...
        PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(0, 32).addBox(-1.0F, -1.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(16, 36).addBox(-1.0F, 10.85F, -2.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.01F))
                .texOffs(35, 29).addBox(2.0F, 10.85F, 1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.01F))
                .texOffs(16, 34).addBox(2.0F, 10.85F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.01F))
                .texOffs(12, 34).addBox(2.0F, 10.85F, -2.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.01F)), PartPose.offset(5.0F, 0.0F, 0.0F));
