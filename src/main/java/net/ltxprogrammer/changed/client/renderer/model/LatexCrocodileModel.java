...
public class LatexCrocodileModel extends LatexHumanoidModel<LatexCrocodile> implements LatexHumanoidModelInterface {
    ...
    public LatexCrocodileModel(ModelPart root) {
        ...
        controller = LatexHumanoidModelController.Builder.of(this, Head, Torso, Tail, RightArm, LeftArm, RightLeg, LeftLeg).hipOffset(-5.0f).legLengthOffset(-4.0f).armLengthOffset(8.0f).build();
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition cube_r38 = Fin3.addOrReplaceChild("cube_r38", CubeListBuilder.create().texOffs(57, 11).addBox(-1.0F, -0.9F, -3.025F, 2.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.0F, -0.5F, -0.1309F, 0.0F, 0.0F));
        ...
        PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(52, 31).addBox(-3.25F, -1.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.25F))
                ...
                .texOffs(32, 66).addBox(-0.275F, 17.05F, -2.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(28, 66).addBox(-3.275F, 17.05F, 1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(20, 66).addBox(-3.275F, 17.05F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(16, 66).addBox(-3.275F, 17.05F, -2.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-6.0F, -9.0F, 0.0F));
        ...
        PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(12, 54).addBox(-0.75F, -1.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.25F))
                ...
                .texOffs(21, 71).addBox(-0.75F, 17.05F, -2.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(12, 71).addBox(2.25F, 17.05F, 1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 69).addBox(2.25F, 17.05F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 67).addBox(2.25F, 17.05F, -2.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(6.0F, -9.0F, 0.0F));
