...
public class SharkBipedalInitAnimator<T extends ChangedEntity, M extends AdvancedHumanoidModel<T>> extends AbstractBipedalUnifiedAnimator<T, M> {
    public SharkBipedalInitAnimator(ModelPart leftLeg, ModelPart leftLegLower, ModelPart leftFoot, ModelPart leftPad,
