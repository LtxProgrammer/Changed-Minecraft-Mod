...
@OnlyIn(Dist.CLIENT)
public class BlackGooWolfMaleModel extends AdvancedHumanoidModel<BlackGooWolfMale> implements AdvancedHumanoidModelInterface<BlackGooWolfMale, BlackGooWolfMaleModel> {
    ...
    private final HumanoidAnimator<BlackGooWolfMale, BlackGooWolfMaleModel> animator;

    public BlackGooWolfMaleModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(BlackGooWolfMale p_102861_, float p_102862_, float p_102863_, float p_102864_) {
    ...
    @Override
    public void setupAnim(@NotNull BlackGooWolfMale entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<BlackGooWolfMale, BlackGooWolfMaleModel> getAnimator() {
        return animator;
    }
}