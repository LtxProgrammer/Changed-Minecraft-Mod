...
public class BlueGooWolfModel extends AdvancedHumanoidModel<BlueGooWolf> implements AdvancedHumanoidModelInterface<BlueGooWolf, BlueGooWolfModel> {
    ...
    private final HumanoidAnimator<BlueGooWolf, BlueGooWolfModel> animator;

    public BlueGooWolfModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(BlueGooWolf p_102861_, float p_102862_, float p_102863_, float p_102864_) {
    ...
    @Override
    public void setupAnim(@NotNull BlueGooWolf entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<BlueGooWolf, BlueGooWolfModel> getAnimator() {
        return animator;
    }
}
