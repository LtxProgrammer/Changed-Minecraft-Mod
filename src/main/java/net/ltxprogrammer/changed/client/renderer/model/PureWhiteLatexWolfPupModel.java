...
public class PureWhiteLatexWolfPupModel extends AdvancedHumanoidModel<PureWhiteLatexWolfPup> implements AdvancedHumanoidModelInterface<PureWhiteLatexWolfPup, PureWhiteLatexWolfPupModel> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition RightThigh_r1 = RightLeg.addOrReplaceChild("RightThigh_r1", CubeListBuilder.create().texOffs(32, 35).addBox(0.0F, 2.075F, -2.1F, 2.0F, 4.0F, 3.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(-1.5F, -4.5F, 0.5F, -0.2182F, 0.0F, 0.0F));
        ...
        PartDefinition RightCalf_r1 = RightLowerLeg.addOrReplaceChild("RightCalf_r1", CubeListBuilder.create().texOffs(38, 23).addBox(-0.99F, -0.625F, -2.15F, 2.0F, 4.0F, 2.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, -1.125F, 1.95F, 0.8727F, 0.0F, 0.0F));
        ...
        PartDefinition RightPad = RightFoot.addOrReplaceChild("RightPad", CubeListBuilder.create().texOffs(40, 4).addBox(-1.0F, 1.0F, -0.85F, 2.0F, 1.0F, 2.0F, CubeDeformation.NONE), PartPose.offset(0.0F, 2.825F, -2.675F));

        PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg", CubeListBuilder.create(), PartPose.offset(2.0F, 18.0F, 7.0F));

        PartDefinition LeftThigh_r1 = LeftLeg.addOrReplaceChild("LeftThigh_r1", CubeListBuilder.create().texOffs(22, 35).addBox(-2.0F, 2.075F, -2.1F, 2.0F, 4.0F, 3.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(1.5F, -4.5F, 0.5F, -0.2182F, 0.0F, 0.0F));
        ...
        PartDefinition LeftCalf_r1 = LeftLowerLeg.addOrReplaceChild("LeftCalf_r1", CubeListBuilder.create().texOffs(38, 11).addBox(-2.01F, -0.625F, -2.15F, 2.0F, 4.0F, 2.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(1.0F, -1.125F, 1.95F, 0.8727F, 0.0F, 0.0F));
        ...
        PartDefinition LeftPad = LeftFoot.addOrReplaceChild("LeftPad", CubeListBuilder.create().texOffs(28, 11).addBox(-1.0F, 1.0F, -0.85F, 2.0F, 1.0F, 2.0F, CubeDeformation.NONE), PartPose.offset(0.0F, 2.825F, -2.675F));
        ...
        PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -4.0F, -6.0F, 8.0F, 8.0F, 6.0F, CubeDeformation.NONE)
                .texOffs(28, 6).addBox(-2.0F, 1.0F, -8.0F, 4.0F, 3.0F, 2.0F, CubeDeformation.NONE), PartPose.offset(0.0F, 12.5F, -4.0F));
        ...
        PartDefinition Torso_r1 = Torso.addOrReplaceChild("Torso_r1", CubeListBuilder.create().texOffs(0, 25).addBox(-3.0F, 3.0F, -2.0F, 6.0F, 7.0F, 5.0F, CubeDeformation.NONE)
        ...
        PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(0, 37).addBox(-1.0F, 0.5F, -1.0F, 2.0F, 6.0F, 2.0F, CubeDeformation.NONE), PartPose.offset(-2.0F, 17.5F, -2.5F));

        PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(8, 37).addBox(-1.0F, 0.5F, -1.0F, 2.0F, 6.0F, 2.0F, CubeDeformation.NONE), PartPose.offset(2.0F, 17.5F, -2.5F));
