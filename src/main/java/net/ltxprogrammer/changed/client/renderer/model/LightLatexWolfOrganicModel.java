...
public class LightLatexWolfOrganicModel extends LatexHumanoidModel<LightLatexWolfOrganic> implements LatexHumanoidModelInterface<LightLatexWolfOrganic, LightLatexWolfOrganicModel> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Base_r1 = Tail.addOrReplaceChild("Base_r1", CubeListBuilder.create().texOffs(40, 23).addBox(-1.5F, 0.2F, -1.5F, 3.0F, 6.0F, 3.0F, new CubeDeformation(-0.01F)), PartPose.offsetAndRotation(0.0F, 2.0F, 6.0F, 1.4835F, 0.0F, 0.0F));
