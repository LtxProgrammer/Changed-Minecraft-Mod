...
public class ArmorSnakeUpperBodyModel<T extends ChangedEntity> extends LatexHumanoidArmorModel<T, ArmorSnakeUpperBodyModel<T>> {
    public static final ArmorModelSet<ChangedEntity, ArmorSnakeUpperBodyModel<ChangedEntity>> MODEL_SET =
            ArmorModelSet.of(Changed.modResource("armor_snake_upper"), ArmorSnakeUpperBodyModel::createArmorLayer, ArmorSnakeUpperBodyModel::new);

    private final ModelPart Head;
    private final ModelPart Torso;
    private final ModelPart LeftArm;
    private final ModelPart RightArm;
    private final HumanoidAnimator<T, ArmorSnakeUpperBodyModel<T>> animator;

    public ArmorSnakeUpperBodyModel(ModelPart modelPart, ArmorModel model) {
        ...
        animator = HumanoidAnimator.of(this).hipOffset(4.0f)
                .addPreset(AnimatorPresets.snakeUpperBodyArmor(
    ...
    @Override
    public HumanoidAnimator<T, ArmorSnakeUpperBodyModel<T>> getAnimator(T entity) {
        return animator;
    }
