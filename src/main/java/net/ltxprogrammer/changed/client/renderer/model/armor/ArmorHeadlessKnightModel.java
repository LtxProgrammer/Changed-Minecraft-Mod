...
public class ArmorHeadlessKnightModel extends LatexHumanoidArmorModel<HeadlessKnight, ArmorHeadlessKnightModel> {
    ...
    public static LayerDefinition createArmorLayer(ArmorModel layer) {
        ...
        PartDefinition LeftLeg = LowerTorso.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(0, 26).mirror().addBox(-1.75F, 12.0F, -1.8F, 4.0F, 2.0F, 4.0F, layer.deformation).mirror(false)
                .texOffs(3, 29).mirror().addBox(-1.75F, 12.0F, -2.8F, 4.0F, 2.0F, 1.0F, layer.deformation).mirror(false), PartPose.offset(3.25F, 3.0F, 0.0F));
        ...
        PartDefinition RightLeg = LowerTorso.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(0, 26).addBox(-1.75F, 12.0F, -1.8F, 4.0F, 2.0F, 4.0F, layer.deformation)
                .texOffs(3, 29).addBox(-1.75F, 12.0F, -2.8F, 4.0F, 2.0F, 1.0F, layer.deformation), PartPose.offset(-3.75F, 3.0F, 0.0F));
        ...
        PartDefinition LeftLeg2 = LowerTorso.addOrReplaceChild("LeftLeg2", CubeListBuilder.create().texOffs(0, 26).mirror().addBox(-2.0F, 12.0F, 0.25F, 4.0F, 2.0F, 4.0F, layer.deformation).mirror(false), PartPose.offset(3.5F, 3.0F, 15.0F));
        ...
        PartDefinition RightLeg2 = LowerTorso.addOrReplaceChild("RightLeg2", CubeListBuilder.create().texOffs(0, 26).addBox(-2.0F, 12.0F, 0.25F, 4.0F, 2.0F, 4.0F, layer.deformation), PartPose.offset(-3.5F, 3.0F, 15.0F));
