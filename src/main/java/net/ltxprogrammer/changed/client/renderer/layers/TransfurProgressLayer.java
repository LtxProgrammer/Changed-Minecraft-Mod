...
public class TransfurProgressLayer extends RenderLayer<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>> {
    ...
    public static Color3 getProgressColor(TransfurVariant<?> variant) {
    ...
    public static Color3 getProgressColor(ResourceLocation type) {
        return Color3.fromInt(ChangedEntities.getEntityColorBack(ChangedRegistry.TRANSFUR_VARIANT.get().getValue(type).getEntityType().getRegistryName()));
    }
