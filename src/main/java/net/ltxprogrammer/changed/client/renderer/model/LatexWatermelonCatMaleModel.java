...
public class LatexWatermelonCatMaleModel extends LatexHumanoidModel<LatexWatermelonCatMale> implements LatexHumanoidModelInterface {
        // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
        public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Changed.modResource("latex_watermelon_cat_male"), "main");
        ...
        public LatexWatermelonCatMaleModel(ModelPart root) {
            super(root);
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            PartDefinition Base_r2 = Tail.addOrReplaceChild("Base_r2", CubeListBuilder.create().texOffs(16, 43).addBox(-1.5F, 0.0F, -1.0F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.001F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.1781F, 0.0F, 0.0F));
            ...
            PartDefinition cube_r1 = RightEar.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(40, 48).addBox(-0.9F, -3.0F, -0.6F, 2.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.0F, -1.0F, 0.2034F, 0.0581F, 0.0598F));
            ...
            PartDefinition base_r3 = LeftEar.addOrReplaceChild("base_r3", CubeListBuilder.create().texOffs(48, 0).addBox(-1.3129F, -2.9943F, -0.7396F, 2.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.2129F, -1.0057F, -0.8604F, 0.2034F, -0.0581F, -0.0598F));
        ...
        @Override
        public void prepareMobModel(LatexWatermelonCatMale p_102861_, float p_102862_, float p_102863_, float p_102864_) {
        ...
        @Override
        public void setupAnim(@NotNull LatexWatermelonCatMale entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
