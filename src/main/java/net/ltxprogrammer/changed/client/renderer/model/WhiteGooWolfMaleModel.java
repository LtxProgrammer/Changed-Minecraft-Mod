...
public class WhiteGooWolfMaleModel extends AdvancedHumanoidModel<WhiteGooWolfMale> implements AdvancedHumanoidModelInterface<WhiteGooWolfMale, WhiteGooWolfMaleModel> {
    ...
    private final HumanoidAnimator<WhiteGooWolfMale, WhiteGooWolfMaleModel> animator;

    public WhiteGooWolfMaleModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(WhiteGooWolfMale p_102861_, float p_102862_, float p_102863_, float p_102864_) {
    ...
    @Override
    public void setupAnim(@NotNull WhiteGooWolfMale entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<WhiteGooWolfMale, WhiteGooWolfMaleModel> getAnimator() {
        return animator;
    }
}
