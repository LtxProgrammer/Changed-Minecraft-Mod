...
@OnlyIn(Dist.CLIENT)
public class PureWhiteLatexWolfModel extends AdvancedHumanoidModel<PureWhiteLatexWolf> implements AdvancedHumanoidModelInterface<PureWhiteLatexWolf, PureWhiteLatexWolfModel> {
    ...
    @Override
    public void prepareMobModel(PureWhiteLatexWolf p_102861_, float p_102862_, float p_102863_, float p_102864_) {
    ...
    @Override
    public void setupAnim(@NotNull PureWhiteLatexWolf entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
