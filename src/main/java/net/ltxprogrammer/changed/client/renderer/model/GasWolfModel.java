...
public class GasWolfModel extends AdvancedHumanoidModel<GasWolf> implements AdvancedHumanoidModelInterface<GasWolf, GasWolfModel> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Changed.modResource("gas_wolf"), "main");
    ...
    private final HumanoidAnimator<GasWolf, GasWolfModel> animator;

    public GasWolfModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(GasWolf p_102861_, float p_102862_, float p_102863_, float p_102864_) {
    ...
    @Override
    public void setupAnim(@NotNull GasWolf entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
