...
import net.ltxprogrammer.changed.client.renderer.model.GooWatermelonCatModel;
...
public class LatexWatermelonCatRenderer extends AdvancedHumanoidRenderer<GooWatermelonCat, GooWatermelonCatModel, ArmorLatexFemaleCatModel<GooWatermelonCat>> {
    public LatexWatermelonCatRenderer(EntityRendererProvider.Context context) {
        super(context, new GooWatermelonCatModel(context.bakeLayer(GooWatermelonCatModel.LAYER_LOCATION)),
    ...
    @Override
    public ResourceLocation getTextureLocation(GooWatermelonCat p_114482_) {
