...
public class ArmorMaleWolfModel<T extends ChangedEntity> extends LatexHumanoidArmorModel<T, ArmorMaleWolfModel<T>> {
    ...
    private final HumanoidAnimator<T, ArmorMaleWolfModel<T>> animator;

    public ArmorMaleWolfModel(ModelPart modelPart) {
    ...
    @Override
    public HumanoidAnimator<T, ArmorMaleWolfModel<T>> getAnimator() {
        return animator;
    }
}
