...
public class CatBipedalSwimAnimator<T extends ChangedEntity, M extends AdvancedHumanoidModel<T>> extends AbstractBipedalUnifiedAnimator<T, M> {
    public CatBipedalSwimAnimator(ModelPart leftLeg, ModelPart leftLegLower, ModelPart leftFoot, ModelPart leftPad,
