...
public class ArmorLatexMaleDragonModel<T extends LatexEntity> extends LatexHumanoidArmorModel<T, ArmorLatexMaleDragonModel<T>> {
    public static final ModelLayerLocation INNER_ARMOR = ArmorModelLayerLocation.createInnerArmorLocation(Changed.modResource("armor_latex_dragon_male_unified")).get();
    public static final ModelLayerLocation OUTER_ARMOR = ArmorModelLayerLocation.createOuterArmorLocation(Changed.modResource("armor_latex_dragon_male_unified")).get();
    ...
    private final LatexAnimator<T, ArmorLatexMaleDragonModel<T>> animator;

    public ArmorLatexMaleDragonModel(ModelPart modelPart) {
    ...
    @Override
    public LatexAnimator<T, ArmorLatexMaleDragonModel<T>> getAnimator() {
        return animator;
    }
}
