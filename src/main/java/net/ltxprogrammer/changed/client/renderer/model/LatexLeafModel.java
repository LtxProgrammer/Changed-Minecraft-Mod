...
public class LatexLeafModel extends LatexHumanoidModel<LatexLeaf> implements LatexHumanoidModelInterface {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(52, 10).addBox(-2.0F, 12.0F, -2.75F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.5F, 10.0F, 0.0F));
        ...
        PartDefinition RightMidLeg_r1 = RightLeg.addOrReplaceChild("RightMidLeg_r1", CubeListBuilder.create().texOffs(40, 20).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 4.25F, -1.5F, 0.5672F, 0.0F, 0.0F));
        ...
        PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(48, 31).addBox(-2.0F, 12.0F, -2.75F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(2.5F, 10.0F, 0.0F));
        ...
        PartDefinition LeftMidLeg_r1 = LeftLeg.addOrReplaceChild("LeftMidLeg_r1", CubeListBuilder.create().texOffs(36, 9).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 4.25F, -1.5F, 0.5672F, 0.0F, 0.0F));
        ...
        PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -34.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
                .texOffs(54, 37).addBox(-2.0F, -29.0F, -6.0F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(0, 6).addBox(-1.5F, -27.0F, -5.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 25.0F, 0.0F));

        PartDefinition Topthing = Head.addOrReplaceChild("Topthing", CubeListBuilder.create().texOffs(24, 0).addBox(-0.5F, -2.7F, -2.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(44, 37).addBox(-1.6F, -2.1F, -2.1F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(52, 16).addBox(-2.2F, -1.0F, -2.0F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.3F, -33.1F, -0.6F, 0.5236F, -0.4363F, 0.6545F));

        PartDefinition RightEarOrHornIDunno = Head.addOrReplaceChild("RightEarOrHornIDunno", CubeListBuilder.create().texOffs(14, 53).addBox(-1.2F, -3.6F, -2.5F, 2.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.3F, -33.0F, 0.0F, -0.8727F, -0.1745F, -0.3927F));

        PartDefinition LeftEarOrHornIDunno = Head.addOrReplaceChild("LeftEarOrHornIDunno", CubeListBuilder.create().texOffs(24, 53).addBox(-0.8F, -3.6F, -2.5F, 2.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.3F, -33.0F, 0.0F, -0.8727F, 0.1745F, 0.3927F));

        PartDefinition RightEar = Head.addOrReplaceChild("RightEar", CubeListBuilder.create().texOffs(43, 53).addBox(-1.25F, -4.9F, -0.5F, 1.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.3F, -31.0F, 0.0F, -0.8727F, -0.3491F, -0.3054F));

        PartDefinition LeftEar = Head.addOrReplaceChild("LeftEar", CubeListBuilder.create().texOffs(34, 53).addBox(0.25F, -4.9F, -0.5F, 1.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.3F, -31.0F, 0.0F, -0.8727F, 0.3491F, 0.3054F));
        ...
        PartDefinition cube_r1 = BottomthingRight.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 57).addBox(-4.35F, -30.2F, 2.4F, 1.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.3F, 31.0F, 0.0F, 0.0262F, -0.3054F, 0.0F));

        PartDefinition cube_r2 = BottomthingRight.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(6, 57).addBox(-5.05F, -30.0F, 0.5F, 1.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.3F, 31.0F, 0.0F, -0.0436F, 0.0F, 0.0F));
        ...
        PartDefinition cube_r3 = BottomthingRight3.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 0).addBox(0.1F, -2.2F, -2.7F, 1.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.15F, 2.8F, 3.4F, 0.0262F, 0.3054F, 0.0F));

        PartDefinition cube_r4 = BottomthingRight3.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(50, 54).addBox(-0.3F, -2.0F, 0.6F, 1.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.15F, 3.0F, 1.5F, -0.0436F, 0.0F, 0.0F));
        ...
        PartDefinition cube_r5 = BottomthingRight2.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(56, 22).addBox(-4.35F, -30.2F, 2.4F, 1.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.3F, 31.0F, 0.0F, 0.0262F, -0.3054F, 0.0F));

        PartDefinition cube_r6 = BottomthingRight2.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(56, 54).addBox(-5.05F, -30.0F, 0.5F, 1.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.3F, 31.0F, 0.0F, -0.0436F, 0.0F, 0.0F));
