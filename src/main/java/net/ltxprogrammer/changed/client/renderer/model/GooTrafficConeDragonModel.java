...
@OnlyIn(Dist.CLIENT)
public class GooTrafficConeDragonModel extends AdvancedHumanoidModel<LatexTrafficConeDragon> implements AdvancedHumanoidModelInterface<LatexTrafficConeDragon, GooTrafficConeDragonModel> {
    ...
    private final HumanoidAnimator<LatexTrafficConeDragon, GooTrafficConeDragonModel> animator;

    public GooTrafficConeDragonModel(ModelPart root) {
        super(root);
    ...
    @Override
    public HumanoidAnimator<LatexTrafficConeDragon, GooTrafficConeDragonModel> getAnimator() {
        return animator;
    }
}