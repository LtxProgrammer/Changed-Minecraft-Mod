...
public class WhiteGooTigerModel extends AdvancedHumanoidModel<LatexWhiteTiger> implements AdvancedHumanoidModelInterface<LatexWhiteTiger, WhiteGooTigerModel> {
        ...
        private final HumanoidAnimator<LatexWhiteTiger, WhiteGooTigerModel> animator;

        public WhiteGooTigerModel(ModelPart root) {
            super(root);
    ...
    @Override
    public HumanoidAnimator<LatexWhiteTiger, WhiteGooTigerModel> getAnimator() {
        return animator;
    }
}