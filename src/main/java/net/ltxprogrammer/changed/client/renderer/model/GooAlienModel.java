...
@OnlyIn(Dist.CLIENT)
public class GooAlienModel extends AdvancedHumanoidModel<LatexAlien> implements AdvancedHumanoidModelInterface<LatexAlien, GooAlienModel> {
	...
	private final HumanoidAnimator<LatexAlien, GooAlienModel> animator;

	public GooAlienModel(ModelPart root) {
		super(root);
	...
	@Override
	public HumanoidAnimator<LatexAlien, GooAlienModel> getAnimator() {
		return animator;
	}
