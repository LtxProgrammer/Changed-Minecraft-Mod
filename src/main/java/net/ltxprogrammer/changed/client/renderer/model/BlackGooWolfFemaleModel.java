...
@OnlyIn(Dist.CLIENT)
public class BlackGooWolfFemaleModel extends AdvancedHumanoidModel<BlackGooWolfFemale> implements AdvancedHumanoidModelInterface<BlackGooWolfFemale, BlackGooWolfFemaleModel> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Changed.modResource("black_goo_wolf_female"), "main");
    ...
    private final HumanoidAnimator<BlackGooWolfFemale, BlackGooWolfFemaleModel> animator;

    public BlackGooWolfFemaleModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(BlackGooWolfFemale p_102861_, float p_102862_, float p_102863_, float p_102864_) {
    ...
    @Override
    public void setupAnim(@NotNull BlackGooWolfFemale entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<BlackGooWolfFemale, BlackGooWolfFemaleModel> getAnimator() {
        return animator;
    }
}