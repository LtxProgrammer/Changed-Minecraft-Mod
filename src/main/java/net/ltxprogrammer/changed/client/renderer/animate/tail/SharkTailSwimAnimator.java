...
public class SharkTailSwimAnimator<T extends LatexEntity, M extends EntityModel<T>> extends AbstractTailAnimator<T, M> {
    ...
    public void setupAnim(@NotNull T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        for (ModelPart joint : tailJoints) {
            joint.yRot = Mth.lerp(core.swimAmount, joint.yRot, -0.35F * Mth.cos(limbSwing * SWIM_RATE -
