...
public class WhiteGooKnightFusionModel extends AdvancedHumanoidModel<WhiteGooKnightFusion> implements AdvancedHumanoidModelInterface<WhiteGooKnightFusion, WhiteGooKnightFusionModel> {
    ...
    private final HumanoidAnimator<WhiteGooKnightFusion, WhiteGooKnightFusionModel> animator;

    public WhiteGooKnightFusionModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(WhiteGooKnightFusion p_102861_, float p_102862_, float p_102863_, float p_102864_) {
    ...
    @Override
    public void setupAnim(@NotNull WhiteGooKnightFusion entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<WhiteGooKnightFusion, WhiteGooKnightFusionModel> getAnimator() {
        return animator;
    }
}
