...
@OnlyIn(Dist.CLIENT)
public class GooSharkModel extends AdvancedHumanoidModel<GooShark> implements AdvancedHumanoidModelInterface<GooShark, GooSharkModel> {
	...
	private final HumanoidAnimator<GooShark, GooSharkModel> animator;

	public GooSharkModel(ModelPart root) {
		super(root);
	...
	@Override
	public void prepareMobModel(GooShark p_102861_, float p_102862_, float p_102863_, float p_102864_) {
	...
	@Override
	public HumanoidAnimator<GooShark, GooSharkModel> getAnimator() {
		return animator;
	}

	@Override
	public void setupAnim(GooShark entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
