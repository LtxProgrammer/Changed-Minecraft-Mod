...
public class BlueGooDragonModel extends AdvancedHumanoidModel<BlueGooDragon> implements AdvancedHumanoidModelInterface<BlueGooDragon, BlueGooDragonModel> {
    ...
    private final HumanoidAnimator<BlueGooDragon, BlueGooDragonModel> animator;

    public BlueGooDragonModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(BlueGooDragon p_102861_, float p_102862_, float p_102863_, float p_102864_) {
    ...
    @Override
    public void setupAnim(@NotNull BlueGooDragon entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<BlueGooDragon, BlueGooDragonModel> getAnimator() {
        return animator;
    }
}
