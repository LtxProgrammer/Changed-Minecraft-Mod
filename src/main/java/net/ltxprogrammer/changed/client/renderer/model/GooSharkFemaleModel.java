...
@OnlyIn(Dist.CLIENT)
public class GooSharkFemaleModel extends AdvancedHumanoidModel<GooSharkFemale> implements AdvancedHumanoidModelInterface<GooSharkFemale, GooSharkFemaleModel> {
	...
	private final HumanoidAnimator<GooSharkFemale, GooSharkFemaleModel> animator;

	public GooSharkFemaleModel(ModelPart root) {
		super(root);
	...
	@Override
	public void prepareMobModel(GooSharkFemale p_102861_, float p_102862_, float p_102863_, float p_102864_) {
	...
	@Override
	public HumanoidAnimator<GooSharkFemale, GooSharkFemaleModel> getAnimator() {
		return animator;
	}
	...
	public static class Remodel extends AdvancedHumanoidModel.LatexRemodel<GooSharkFemale, Remodel> {
		private final ModelPart RightLeg;
		private final ModelPart LeftLeg;
		private final ModelPart RightArm;
		private final ModelPart LeftArm;
		...
		private final ModelPart Torso;
		private final ModelPart Tail;
		private final HumanoidAnimator<GooSharkFemale, Remodel> animator;
		...
		@Override
		public HumanoidAnimator<GooSharkFemale, Remodel> getAnimator() {
			return animator;
		}
