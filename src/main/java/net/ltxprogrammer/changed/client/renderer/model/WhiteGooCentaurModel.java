...
public class WhiteGooCentaurModel extends AdvancedHumanoidModel<WhiteGooCentaur> implements AdvancedHumanoidModelInterface<WhiteGooCentaur, WhiteGooCentaurModel>, LowerTorsoedModel {
    ...
    private final HumanoidAnimator<WhiteGooCentaur, WhiteGooCentaurModel> animator;

    public WhiteGooCentaurModel(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Torso = partdefinition.addOrReplaceChild("Torso", CubeListBuilder.create().texOffs(0, 16).addBox(-4.0F, -1.0F, -2.0F, 8.0F, 12.0F, 4.0F, CubeDeformation.NONE), PartPose.offset(0.0F, -2.0F, -7.0F));
        ...
        PartDefinition LeftLeg = LowerTorso.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(12, 44).addBox(-1.75F, 12.0F, -1.8F, 4.0F, 2.0F, 4.0F, CubeDeformation.NONE)
                .texOffs(15, 47).addBox(-1.75F, 12.0F, -2.8F, 4.0F, 2.0F, 1.0F, CubeDeformation.NONE), PartPose.offset(3.5F, 0.0F, 0.0F));
        ...
        PartDefinition RightLeg = LowerTorso.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(43, 42).addBox(-1.75F, 12.0F, -1.8F, 4.0F, 2.0F, 4.0F, CubeDeformation.NONE)
                .texOffs(46, 45).addBox(-1.75F, 12.0F, -2.8F, 4.0F, 2.0F, 1.0F, CubeDeformation.NONE), PartPose.offset(-4.0F, 0.0F, 0.0F));
        ...
        PartDefinition LeftLeg2 = LowerTorso.addOrReplaceChild("LeftLeg2", CubeListBuilder.create().texOffs(26, 57).addBox(-2.0F, 12.0F, 0.25F, 4.0F, 2.0F, 4.0F, CubeDeformation.NONE), PartPose.offset(3.75F, 0.0F, 15.0F));
        ...
        PartDefinition RightLeg2 = LowerTorso.addOrReplaceChild("RightLeg2", CubeListBuilder.create().texOffs(56, 57).addBox(-2.0F, 12.0F, 0.25F, 4.0F, 2.0F, 4.0F, CubeDeformation.NONE), PartPose.offset(-3.75F, 0.0F, 15.0F));
    ...
    @Override
    public void prepareMobModel(WhiteGooCentaur p_102861_, float p_102862_, float p_102863_, float p_102864_) {
    ...
    @Override
    public void setupAnim(@NotNull WhiteGooCentaur entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<WhiteGooCentaur, WhiteGooCentaurModel> getAnimator() {
        return animator;
    }
