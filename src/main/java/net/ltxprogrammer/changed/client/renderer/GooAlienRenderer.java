...
import net.ltxprogrammer.changed.client.renderer.model.GooAlienModel;
...
public class GooAlienRenderer extends AdvancedHumanoidRenderer<LatexAlien, GooAlienModel, ArmorLatexAlienModel<LatexAlien>> {
    public GooAlienRenderer(EntityRendererProvider.Context context) {
        super(context, new GooAlienModel(context.bakeLayer(GooAlienModel.LAYER_LOCATION)),
