...
public class PureWhiteGooWolfModel extends AdvancedHumanoidModel<PureWhiteGooWolf> implements AdvancedHumanoidModelInterface<PureWhiteGooWolf, PureWhiteGooWolfModel> {
    ...
    private final HumanoidAnimator<PureWhiteGooWolf, PureWhiteGooWolfModel> animator;

    public PureWhiteGooWolfModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(PureWhiteGooWolf p_102861_, float p_102862_, float p_102863_, float p_102864_) {
    ...
    @Override
    public void setupAnim(@NotNull PureWhiteGooWolf entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<PureWhiteGooWolf, PureWhiteGooWolfModel> getAnimator() {
        return animator;
    }
}