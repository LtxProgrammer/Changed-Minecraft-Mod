...
public class LatexStigerModel extends LatexHumanoidModel<LatexStiger> implements LatexHumanoidModelInterface {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.5F, -4.0F, 8.0F, 8.0F, 8.0F, CubeDeformation.NONE)
                .texOffs(24, 0).addBox(-2.0F, -3.5F, -6.0F, 4.0F, 2.0F, 2.0F, CubeDeformation.NONE)
                .texOffs(0, 5).addBox(-1.5F, -1.5F, -5.0F, 3.0F, 1.0F, 1.0F, CubeDeformation.NONE), PartPose.offset(0.0F, -0.5F, 0.0F));

        PartDefinition Snout_r1 = Head.addOrReplaceChild("Snout_r1", CubeListBuilder.create().texOffs(47, 1).addBox(-1.0F, -29.625F, -0.95F, 1.0F, 1.0F, 1.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.5F, 25.5F, 0.0F, 0.1745F, 0.0F, 0.0F));

        PartDefinition RightEar = Head.addOrReplaceChild("RightEar", CubeListBuilder.create(), PartPose.offsetAndRotation(-3.0F, -8.5F, 0.0F, 0.0F, 0.0F, -0.2618F));
        ...
        PartDefinition Hair = Head.addOrReplaceChild("Hair", CubeListBuilder.create().texOffs(16, 31).addBox(-2.0F, -34.75F, -4.0F, 4.0F, 1.0F, 8.0F, CubeDeformation.NONE)
                ...
                .texOffs(64, 10).addBox(-3.5F, -33.0F, -4.25F, 7.0F, 1.0F, 1.0F, CubeDeformation.NONE), PartPose.offset(0.0F, 25.5F, 0.0F));
        ...
        PartDefinition Torso = partdefinition.addOrReplaceChild("Torso", CubeListBuilder.create().texOffs(0, 16).addBox(-4.0F, -0.5F, -2.0F, 8.0F, 12.0F, 4.0F, CubeDeformation.NONE)
                ...
                .texOffs(68, 61).addBox(-3.0F, 2.25F, -2.5F, 6.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(48, 26).addBox(-4.0F, -0.5F, -2.5F, 8.0F, 3.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(68, 40).addBox(-3.0F, 1.5F, 1.5F, 6.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(66, 22).addBox(-3.0F, -0.5F, -2.75F, 6.0F, 2.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(20, 16).addBox(-2.0F, 1.5F, -2.75F, 4.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(64, 32).addBox(-3.0F, -0.5F, 1.75F, 6.0F, 2.0F, 1.0F, CubeDeformation.NONE), PartPose.offset(0.0F, -0.5F, 0.0F));

        PartDefinition lefttuft_r1 = Torso.addOrReplaceChild("lefttuft_r1", CubeListBuilder.create().texOffs(41, 65).addBox(-11.5F, -23.5F, -2.5F, 1.0F, 2.0F, 5.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 24.5F, 0.0F, 0.0F, 0.0F, 0.6109F));

        PartDefinition righttuft_r1 = Torso.addOrReplaceChild("righttuft_r1", CubeListBuilder.create().texOffs(64, 3).addBox(10.5F, -23.5F, -2.5F, 1.0F, 2.0F, 5.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 24.5F, 0.0F, 0.0F, 0.0F, -0.6109F));
        ...
        PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(0, 32).addBox(-3.0F, -2.5F, -2.0F, 4.0F, 12.0F, 4.0F, CubeDeformation.NONE)
                .texOffs(32, 46).addBox(0.0F, 9.25F, -2.0F, 1.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(32, 44).addBox(-3.0F, 9.25F, 1.0F, 1.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(44, 2).addBox(-3.0F, 9.25F, -0.5F, 1.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(44, 0).addBox(-3.0F, 9.25F, -2.0F, 1.0F, 1.0F, 1.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(-5.0F, 1.5F, -0.5F, 0.0F, 0.0F, 0.1745F));

        PartDefinition RightArm2 = partdefinition.addOrReplaceChild("RightArm2", CubeListBuilder.create().texOffs(36, 36).addBox(-3.0F, -2.5F, -1.7F, 4.0F, 12.0F, 4.0F, CubeDeformation.NONE)
                .texOffs(36, 36).addBox(0.0F, 9.25F, -1.7F, 1.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(32, 36).addBox(-3.0F, 9.25F, 1.3F, 1.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(12, 34).addBox(-3.0F, 9.25F, -0.2F, 1.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(32, 33).addBox(-3.0F, 9.25F, -1.7F, 1.0F, 1.0F, 1.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(-5.0F, 3.5F, -0.3F, 0.0F, 0.0F, 0.0873F));

        PartDefinition RightArm3 = partdefinition.addOrReplaceChild("RightArm3", CubeListBuilder.create().texOffs(32, 0).addBox(-3.0F, -2.5F, -2.0F, 4.0F, 12.0F, 4.0F, CubeDeformation.NONE)
                .texOffs(32, 31).addBox(0.0F, 9.25F, -2.0F, 1.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(12, 32).addBox(-3.0F, 9.25F, 1.0F, 1.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(28, 4).addBox(-3.0F, 9.25F, -0.5F, 1.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(20, 18).addBox(-3.0F, 9.25F, -2.0F, 1.0F, 1.0F, 1.0F, CubeDeformation.NONE), PartPose.offset(-5.0F, 5.5F, 0.5F));

        PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(16, 56).addBox(-1.0F, 9.25F, -1.7F, 1.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(44, 55).addBox(2.0F, 9.25F, 1.3F, 1.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(40, 54).addBox(2.0F, 9.25F, -0.2F, 1.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(52, 43).addBox(2.0F, 9.25F, -1.7F, 1.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(48, 0).addBox(-1.0F, -2.5F, -1.7F, 4.0F, 12.0F, 4.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(5.0F, 1.5F, -0.8F, 0.0F, 0.0F, -0.1745F));

        PartDefinition LeftArm2 = partdefinition.addOrReplaceChild("LeftArm2", CubeListBuilder.create().texOffs(32, 42).addBox(-1.0F, 9.25F, -1.7F, 1.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(28, 42).addBox(2.0F, 9.25F, 1.3F, 1.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(16, 42).addBox(2.0F, 9.25F, -0.2F, 1.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(32, 40).addBox(2.0F, 9.25F, -1.7F, 1.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(0, 48).addBox(-1.0F, -2.5F, -1.7F, 4.0F, 12.0F, 4.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(5.0F, 3.5F, -0.3F, 0.0F, 0.0F, -0.0873F));

        PartDefinition LeftArm3 = partdefinition.addOrReplaceChild("LeftArm3", CubeListBuilder.create().texOffs(28, 40).addBox(-1.0F, 9.25F, -2.0F, 1.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(16, 40).addBox(2.0F, 9.25F, 1.0F, 1.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(20, 37).addBox(2.0F, 9.25F, -0.5F, 1.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(16, 37).addBox(2.0F, 9.25F, -2.0F, 1.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(16, 40).addBox(-1.0F, -2.5F, -2.0F, 4.0F, 12.0F, 4.0F, CubeDeformation.NONE), PartPose.offset(5.0F, 5.5F, 0.5F));
