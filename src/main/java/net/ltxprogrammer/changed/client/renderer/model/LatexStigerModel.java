...
public class LatexStigerModel extends LatexHumanoidModel<LatexStiger> implements LatexHumanoidModelInterface {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition leftupperantenna_r1 = Head.addOrReplaceChild("leftupperantenna_r1", CubeListBuilder.create().texOffs(0, 32).addBox(2.0F, -29.25F, -25.1F, 1.0F, 3.0F, 1.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 25.5F, 0.0F, -0.6981F, 0.0873F, 0.0F));

        PartDefinition leftlowerantenna_r1 = Head.addOrReplaceChild("leftlowerantenna_r1", CubeListBuilder.create().texOffs(0, 0).addBox(1.5F, -34.0F, -13.6F, 2.0F, 3.0F, 2.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 25.5F, 0.0F, -0.3054F, 0.0873F, 0.0F));

        PartDefinition rightupperantenna_r1 = Head.addOrReplaceChild("rightupperantenna_r1", CubeListBuilder.create().texOffs(0, 16).addBox(-3.0F, -29.25F, -25.1F, 1.0F, 3.0F, 1.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 25.5F, 0.0F, -0.6981F, -0.0873F, 0.0F));

        PartDefinition rightlowerantenna_r1 = Head.addOrReplaceChild("rightlowerantenna_r1", CubeListBuilder.create().texOffs(16, 32).addBox(-3.5F, -34.0F, -13.6F, 2.0F, 3.0F, 2.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 25.5F, 0.0F, -0.3054F, -0.0873F, 0.0F));
