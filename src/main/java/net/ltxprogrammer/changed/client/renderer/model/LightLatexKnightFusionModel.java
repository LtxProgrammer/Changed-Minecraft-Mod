...
public class LightLatexKnightFusionModel extends LatexHumanoidModel<LightLatexKnightFusion> implements LatexHumanoidModelInterface<LightLatexKnightFusion, LightLatexKnightFusionModel> {
    ...
    private final LatexAnimator<LightLatexKnightFusion, LightLatexKnightFusionModel> animator;
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition TailTertiary = TailSecondary.addOrReplaceChild("TailTertiary", CubeListBuilder.create(), PartPose.offset(0.0F, 1.05F, 5.5F));

        PartDefinition Base_r3 = TailTertiary.addOrReplaceChild("Base_r3", CubeListBuilder.create().texOffs(52, 32).addBox(-2.0F, -1.2F, -1.95F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-0.15F)), PartPose.offsetAndRotation(0.0F, -0.3F, 1.0F, 1.8326F, 0.0F, 0.0F));
    ...
    @Override
    public LatexAnimator<LightLatexKnightFusion, LightLatexKnightFusionModel> getAnimator() {
        return animator;
    }
}
