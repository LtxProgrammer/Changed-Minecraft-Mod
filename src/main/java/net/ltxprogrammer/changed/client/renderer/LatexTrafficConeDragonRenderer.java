...
import net.ltxprogrammer.changed.client.renderer.model.GooTrafficConeDragonModel;
...
public class LatexTrafficConeDragonRenderer extends AdvancedHumanoidRenderer<LatexTrafficConeDragon, GooTrafficConeDragonModel, ArmorLatexBigTailDragonModel<LatexTrafficConeDragon>> {
	public LatexTrafficConeDragonRenderer(EntityRendererProvider.Context context) {
		super(context, new GooTrafficConeDragonModel(context.bakeLayer(GooTrafficConeDragonModel.LAYER_LOCATION)),
