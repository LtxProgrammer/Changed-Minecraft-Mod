...
public class TaurBipedalStandAnimator<T extends LatexEntity, M extends EntityModel<T>> extends AbstractQuadrupedalAnimator<T, M> {
    ...
    public TaurBipedalStandAnimator(ModelPart torso, ModelPart frontLeftLeg, ModelPart frontLeftLegLower, ModelPart frontLeftFoot,
    ...
    public void setupAnim(@NotNull T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        frontRightLeg.y = core.calculateLegPositionY() - 9.0f + offset;
        frontLeftLeg.y = core.calculateLegPositionY() - 9.0f + offset;
        backRightLeg.y = core.calculateLegPositionY() - 9.0f + offset;
        backLeftLeg.y = core.calculateLegPositionY() - 9.0f + offset;
    }
}
