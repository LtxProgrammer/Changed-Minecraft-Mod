...
@OnlyIn(Dist.CLIENT)
public class GooSnakeModel extends AdvancedHumanoidModel<GooSnake> implements AdvancedHumanoidModelInterface<GooSnake, GooSnakeModel>, LeglessModel {
    ...
    private final HumanoidAnimator<GooSnake, GooSnakeModel> animator;

    public GooSnakeModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(GooSnake p_102861_, float p_102862_, float p_102863_, float p_102864_) {
    ...
    @Override
    public void setupAnim(@NotNull GooSnake entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<GooSnake, GooSnakeModel> getAnimator() {
        return animator;
    }
}