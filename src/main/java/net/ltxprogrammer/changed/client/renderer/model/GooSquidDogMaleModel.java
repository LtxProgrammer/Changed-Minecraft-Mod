...
public class GooSquidDogMaleModel extends AdvancedHumanoidModel<GooSquidDogMale> implements AdvancedHumanoidModelInterface<GooSquidDogMale, GooSquidDogMaleModel>, DoubleArmedModel {
    ...
    private final HumanoidAnimator<GooSquidDogMale, GooSquidDogMaleModel> animator;

    public GooSquidDogMaleModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(GooSquidDogMale p_102861_, float p_102862_, float p_102863_, float p_102864_) {
        this.prepareMobModel(animator, p_102861_, p_102862_, p_102863_, p_102864_);
    }

    @Override
    public void setupAnim(GooSquidDogMale entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float HeadPitch) {
    ...
    @Override
    public HumanoidAnimator<GooSquidDogMale, GooSquidDogMaleModel> getAnimator() {
        return animator;
    }
