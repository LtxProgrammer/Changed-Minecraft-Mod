...
@OnlyIn(Dist.CLIENT)
public class LatexTrafficConeDragonModel extends AdvancedHumanoidModel<LatexTrafficConeDragon> implements AdvancedHumanoidModelInterface<LatexTrafficConeDragon, LatexTrafficConeDragonModel> {
