...
import net.ltxprogrammer.changed.entity.beast.BlackGooYufeng;
...
@OnlyIn(Dist.CLIENT)
public class BlackGooYufengModel extends AdvancedHumanoidModel<BlackGooYufeng> implements AdvancedHumanoidModelInterface<BlackGooYufeng, BlackGooYufengModel> {
    ...
    private final HumanoidAnimator<BlackGooYufeng, BlackGooYufengModel> animator;

    public BlackGooYufengModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(BlackGooYufeng p_102861_, float p_102862_, float p_102863_, float p_102864_) {
    ...
    @Override
    public void setupAnim(@NotNull BlackGooYufeng entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<BlackGooYufeng, BlackGooYufengModel> getAnimator() {
        return animator;
    }
}