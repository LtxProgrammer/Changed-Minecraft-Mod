...
public class BlackGooPupModel extends AdvancedHumanoidModel<BlackGooPup> implements AdvancedHumanoidModelInterface<BlackGooPup, BlackGooPupModel> {
    ...
    private final HumanoidAnimator<BlackGooPup, BlackGooPupModel> animator;

    public BlackGooPupModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(BlackGooPup entity, float p_102665_, float p_102666_, float partialTicks) {
        if (entity.isPuddle()) {
    ...
    @Override
    public void setupAnim(@NotNull BlackGooPup entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<BlackGooPup, BlackGooPupModel> getAnimator() {
        return animator;
    }
}
