...
@OnlyIn(Dist.CLIENT)
public class WhiteLatexWolfModel extends LatexHumanoidModel<WhiteLatexWolf> implements LatexHumanoidModelInterface {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition RightEar = Head.addOrReplaceChild("RightEar", CubeListBuilder.create().texOffs(0, 4).addBox(-1.5088F, -1.0341F, -1.0F, 3.0F, 3.0F, 1.0F, NO_DEFORMATION)
                .texOffs(16, 38).addBox(-0.5088F, -2.0341F, -1.0F, 2.0F, 1.0F, 1.0F, NO_DEFORMATION)
                .texOffs(8, 48).addBox(0.4912F, -3.0341F, -1.0F, 1.0F, 1.0F, 1.0F,NO_DEFORMATION), PartPose.offsetAndRotation(-3.0F, -34.0F, 0.0F, 0.0F, 0.0F, -0.2618F));

        PartDefinition LeftEar = Head.addOrReplaceChild("LeftEar", CubeListBuilder.create().texOffs(0, 0).addBox(-1.4912F, -1.0341F, -1.0F, 3.0F, 3.0F, 1.0F, NO_DEFORMATION)
                .texOffs(16, 36).addBox(-1.4912F, -2.0341F, -1.0F, 2.0F, 1.0F, 1.0F, NO_DEFORMATION)
                .texOffs(4, 48).addBox(-1.4912F, -3.0341F, -1.0F, 1.0F, 1.0F, 1.0F, NO_DEFORMATION), PartPose.offsetAndRotation(3.0F, -34.0F, 0.0F, 0.0F, 0.0F, 0.2618F));
        ...
        PartDefinition Torso = partdefinition.addOrReplaceChild("Torso", CubeListBuilder.create().texOffs(0, 16).addBox(-4.0F, -25.0F, -2.0F, 8.0F, 12.0F, 4.0F, NO_DEFORMATION)
                .texOffs(28, 36).addBox(-2.0F, -23.0F, -2.75F, 4.0F, 1.0F, 1.0F, NO_DEFORMATION)
                .texOffs(58, 19).addBox(-3.0F, -23.0F, 1.5F, 6.0F, 1.0F, 1.0F, NO_DEFORMATION)
                .texOffs(57, 47).addBox(-3.0F, -25.0F, -2.75F, 6.0F, 2.0F, 1.0F, NO_DEFORMATION)
                .texOffs(24, 6).addBox(-3.0F, -22.0F, -2.5F, 6.0F, 1.0F, 1.0F, NO_DEFORMATION)
                .texOffs(24, 0).addBox(-4.0F, -25.0F, -2.5F, 8.0F, 3.0F, 1.0F, NO_DEFORMATION)
                .texOffs(52, 0).addBox(-4.0F, -25.0F, 1.5F, 8.0F, 2.0F, 1.0F, NO_DEFORMATION)
                .texOffs(56, 21).addBox(-3.0F, -25.0F, 1.75F, 6.0F, 2.0F, 1.0F, NO_DEFORMATION), PartPose.offset(0.0F, 24.0F, 0.0F));

        PartDefinition LeftTuft_r1 = Torso.addOrReplaceChild("LeftTuft_r1", CubeListBuilder.create().texOffs(55, 51).addBox(-11.5F, -23.5F, -2.5F, 1.0F, 2.0F, 5.0F, NO_DEFORMATION), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.6109F));

        PartDefinition RightTuft_r1 = Torso.addOrReplaceChild("RightTuft_r1", CubeListBuilder.create().texOffs(56, 3).addBox(10.5F, -23.5F, -2.5F, 1.0F, 2.0F, 5.0F, NO_DEFORMATION), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.6109F));
        ...
        PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(24, 17).addBox(-8.0F, -26.0F, -2.0F, 4.0F, 12.0F, 4.0F, NO_DEFORMATION)
                .texOffs(32, 44).addBox(-5.0F, -14.25F, -2.0F, 1.0F, 1.0F, 1.0F, NO_DEFORMATION)
                .texOffs(44, 31).addBox(-8.0F, -14.25F, 1.0F, 1.0F, 1.0F, 1.0F, NO_DEFORMATION)
                .texOffs(28, 44).addBox(-8.0F, -14.25F, -0.5F, 1.0F, 1.0F, 1.0F, NO_DEFORMATION)
                .texOffs(24, 44).addBox(-8.0F, -14.25F, -2.0F, 1.0F, 1.0F, 1.0F, NO_DEFORMATION), PartPose.offset(0.0F, 25.0F, 0.0F));
        ...
        PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(0, 32).addBox(4.0F, -26.0F, -2.0F, 4.0F, 12.0F, 4.0F, NO_DEFORMATION)
                .texOffs(0, 48).addBox(4.0F, -14.25F, -2.0F, 1.0F, 1.0F, 1.0F, NO_DEFORMATION)
                .texOffs(24, 46).addBox(7.0F, -14.25F, 1.0F, 1.0F, 1.0F, 1.0F, NO_DEFORMATION)
                .texOffs(46, 13).addBox(7.0F, -14.25F, -0.5F, 1.0F, 1.0F, 1.0F, NO_DEFORMATION)
                .texOffs(46, 11).addBox(7.0F, -14.25F, -2.0F, 1.0F, 1.0F, 1.0F, NO_DEFORMATION), PartPose.offset(0.0F, 25.0F, 0.0F));
