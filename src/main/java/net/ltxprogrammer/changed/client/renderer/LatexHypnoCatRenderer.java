...
public class LatexHypnoCatRenderer extends AdvancedHumanoidRenderer<GooHypnoCat, LatexHypnoCatModel, ArmorLatexMaleCatModel<GooHypnoCat>> {
    ...
    @Override
    public ResourceLocation getTextureLocation(GooHypnoCat p_114482_) {
