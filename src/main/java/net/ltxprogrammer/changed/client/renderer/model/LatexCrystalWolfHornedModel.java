...
public class LatexCrystalWolfHornedModel extends LatexHumanoidModel<LatexCrystalWolfHorned> implements LatexHumanoidModelInterface<LatexCrystalWolfHorned, LatexCrystalWolfHornedModel> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(52, 41).addBox(-2.0F, 12.0F, -2.75F, 4.0F, 2.0F, 4.0F, new CubeDeformation(-0.005F)), PartPose.offset(-2.5F, 10.0F, 0.0F));
        ...
        PartDefinition Toe_r2 = RightLeg.addOrReplaceChild("Toe_r2", CubeListBuilder.create().texOffs(32, 38).addBox(-1.0F, -3.0F, -1.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.01F))
                .texOffs(36, 38).addBox(-2.5F, -3.0F, -1.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.01F))
                .texOffs(40, 11).addBox(-4.0F, -3.0F, -1.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.01F)), PartPose.offsetAndRotation(2.0F, 16.0F, -1.75F, 0.0F, 0.0F, 0.0F));
        ...
        PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(48, 11).addBox(-2.0F, 12.0F, -2.75F, 4.0F, 2.0F, 4.0F, new CubeDeformation(-0.005F)), PartPose.offset(2.5F, 10.0F, 0.0F));
        ...
        PartDefinition Toe_r4 = LeftLeg.addOrReplaceChild("Toe_r4", CubeListBuilder.create().texOffs(43, 12).addBox(-1.0F, -3.0F, -1.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.01F))
                .texOffs(43, 14).addBox(-2.5F, -3.0F, -1.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.01F))
                .texOffs(43, 22).addBox(-4.0F, -3.0F, -1.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.01F)), PartPose.offsetAndRotation(2.0F, 16.0F, -1.75F, 0.0F, 0.0F, 0.0F));
        ...
        PartDefinition Head_r1 = Head.addOrReplaceChild("Head_r1", CubeListBuilder.create().texOffs(78, 9).addBox(-5.5F, -7.0F, 1.85F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.05F))
                .texOffs(6, 66).addBox(-5.5F, -8.0F, 2.75F, 1.0F, 2.0F, 3.0F, new CubeDeformation(-0.05F))
                .texOffs(23, 66).addBox(-4.5F, -8.0F, 4.75F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.05F))
                .texOffs(70, 0).addBox(-2.5F, -8.0F, 1.75F, 2.0F, 2.0F, 4.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0F, 0.5F, 0.0F, 0.3491F, -0.3491F, 0.0F));

        PartDefinition Head_r2 = Head.addOrReplaceChild("Head_r2", CubeListBuilder.create().texOffs(77, 0).addBox(4.5F, -7.0F, 1.85F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.05F))
                .texOffs(31, 63).addBox(4.5F, -8.0F, 2.75F, 1.0F, 2.0F, 3.0F, new CubeDeformation(-0.05F))
                .texOffs(23, 62).addBox(1.5F, -8.0F, 4.75F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.05F))
                .texOffs(70, 8).addBox(0.5F, -8.0F, 1.75F, 2.0F, 2.0F, 4.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0F, 0.5F, 0.0F, 0.3491F, 0.3491F, 0.0F));
