...
public class BipedalCrouchAnimator<T extends ChangedEntity, M extends AdvancedHumanoidModel<T>> extends AbstractBipedalAnimator<T, M> {
    ...
    public void setupAnim(@NotNull T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        rightLeg.z = 4.0F + 0.0F + ((core.torsoLength - 12.0f) / 1.83048772171f);
        leftLeg.z = 4.0F + 0.0F + ((core.torsoLength - 12.0f) / 1.83048772171f);
