...
public class WhiteLatexWolfMaleModel extends AdvancedHumanoidModel<WhiteLatexWolfMale> implements AdvancedHumanoidModelInterface<WhiteLatexWolfMale, WhiteLatexWolfMaleModel> {
    ...
    @Override
    public void prepareMobModel(WhiteLatexWolfMale p_102861_, float p_102862_, float p_102863_, float p_102864_) {
    ...
    @Override
    public void setupAnim(@NotNull WhiteLatexWolfMale entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<WhiteLatexWolfMale, WhiteLatexWolfMaleModel> getAnimator() {
        return animator;
    }
}
