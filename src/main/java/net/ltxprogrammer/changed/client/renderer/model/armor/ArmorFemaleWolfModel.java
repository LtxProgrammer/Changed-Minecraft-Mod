...
public class ArmorFemaleWolfModel<T extends ChangedEntity> extends LatexHumanoidArmorModel<T, ArmorFemaleWolfModel<T>> {
    ...
    private final HumanoidAnimator<T, ArmorFemaleWolfModel<T>> animator;

    public ArmorFemaleWolfModel(ModelPart modelPart) {
    ...
    @Override
    public HumanoidAnimator<T, ArmorFemaleWolfModel<T>> getAnimator() {
        return animator;
    }
}
