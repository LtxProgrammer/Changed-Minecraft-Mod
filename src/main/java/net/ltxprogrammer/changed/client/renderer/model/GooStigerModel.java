...
public class GooStigerModel extends AdvancedHumanoidModel<GooStiger> implements AdvancedHumanoidModelInterface<GooStiger, GooStigerModel> {
    ...
    public final HumanoidAnimator<GooStiger, GooStigerModel> animator;

    public GooStigerModel(ModelPart root) {
        super(root);
        ...
        animator = HumanoidAnimator.of(this).addPreset(AnimatorPresets.wolfLikeOld(Head, Torso, LeftArm, RightArm, Torso.getChild("Tail"), List.of(), LeftLeg, RightLeg))
    ...
    @Override
    public void prepareMobModel(GooStiger p_102861_, float p_102862_, float p_102863_, float p_102864_) {
    ...
    @Override
    public HumanoidAnimator<GooStiger, GooStigerModel> getAnimator() {
        return animator;
    }
