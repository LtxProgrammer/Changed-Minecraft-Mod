...
public class DragonBipedalInitAnimator<T extends ChangedEntity, M extends AdvancedHumanoidModel<T>> extends AbstractBipedalUnifiedAnimator<T, M> {
    public DragonBipedalInitAnimator(ModelPart leftLeg, ModelPart leftLegLower, ModelPart leftFoot, ModelPart leftPad,
