...
public class GooSquirrelModel extends AdvancedHumanoidModel<GooSquirrel> implements AdvancedHumanoidModelInterface<GooSquirrel, GooSquirrelModel> {
    ...
    private final HumanoidAnimator<GooSquirrel, GooSquirrelModel> animator;

    public GooSquirrelModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(GooSquirrel p_102861_, float p_102862_, float p_102863_, float p_102864_) {
    ...
    @Override
    public HumanoidAnimator<GooSquirrel, GooSquirrelModel> getAnimator() {
        return animator;
    }

    @Override
    public void setupAnim(GooSquirrel entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
