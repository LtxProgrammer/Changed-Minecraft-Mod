...
@OnlyIn(Dist.CLIENT)
public class BeifengModel extends AdvancedHumanoidModel<Beifeng> implements AdvancedHumanoidModelInterface<Beifeng, BeifengModel> {
    ...
    private final HumanoidAnimator<Beifeng, BeifengModel> animator;

    public BeifengModel(ModelPart root) {
        super(root);
    ...
    @Override
    public HumanoidAnimator<Beifeng, BeifengModel> getAnimator() {
        return animator;
    }
}