...
import net.ltxprogrammer.changed.client.renderer.model.GooDeerModel;
...
public class LatexDeerRenderer extends AdvancedHumanoidRenderer<LatexDeer, GooDeerModel, ArmorLatexYuinModel<LatexDeer>> {
    public LatexDeerRenderer(EntityRendererProvider.Context context) {
        super(context, new GooDeerModel(context.bakeLayer(GooDeerModel.LAYER_LOCATION)),
