...
public class ArmorLatexFemaleSharkModel<T extends LatexEntity> extends LatexHumanoidArmorModel<T, ArmorLatexFemaleSharkModel<T>> {
    ...
    private final LatexAnimator<T, ArmorLatexFemaleSharkModel<T>> animator;
    ...
    @Override
    public LatexAnimator<T, ArmorLatexFemaleSharkModel<T>> getAnimator() {
        return animator;
    }
}
