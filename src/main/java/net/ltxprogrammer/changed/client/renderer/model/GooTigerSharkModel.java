...
public class GooTigerSharkModel extends AdvancedHumanoidModel<GooTigerShark> implements AdvancedHumanoidModelInterface<GooTigerShark, GooTigerSharkModel> {
    ...
    private final HumanoidAnimator<GooTigerShark, GooTigerSharkModel> animator;

    public GooTigerSharkModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(GooTigerShark p_102861_, float p_102862_, float p_102863_, float p_102864_) {
    ...
    @Override
    public void setupAnim(@NotNull GooTigerShark entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<GooTigerShark, GooTigerSharkModel> getAnimator() {
        return animator;
    }
}