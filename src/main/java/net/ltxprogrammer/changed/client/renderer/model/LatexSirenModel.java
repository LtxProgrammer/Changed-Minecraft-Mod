...
public class LatexSirenModel extends LatexHumanoidModel<LatexSiren> implements LatexHumanoidModelInterface {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Base_r3 = LowerAbdomen.addOrReplaceChild("Base_r3", CubeListBuilder.create().texOffs(58, 37).addBox(-5.0F, 1.0634F, -2.9031F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.0025F, 1.0529F, -0.5236F, 0.0F, 0.0F));
        ...
        PartDefinition Base_r4 = Tail.addOrReplaceChild("Base_r4", CubeListBuilder.create().texOffs(0, 31).addBox(-4.0F, 3.8569F, -3.5836F, 8.0F, 7.0F, 5.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0F, -5.0025F, 1.0529F, 0.2007F, 0.0F, 0.0F));

        PartDefinition Joint = Tail.addOrReplaceChild("Joint", CubeListBuilder.create(), PartPose.offset(0.0F, 5.8854F, 2.329F));

        PartDefinition Base_r5 = Joint.addOrReplaceChild("Base_r5", CubeListBuilder.create().texOffs(52, 18).addBox(-3.0F, 16.8531F, -2.848F, 6.0F, 6.0F, 4.0F, new CubeDeformation(-0.15F))
        ...
        PartDefinition Base_r6 = Joint2.addOrReplaceChild("Base_r6", CubeListBuilder.create().texOffs(36, 46).addBox(-0.5F, 34.3872F, 7.1776F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.05F))
        ...
        PartDefinition Base_r7 = Joint2.addOrReplaceChild("Base_r7", CubeListBuilder.create().texOffs(0, 14).addBox(-0.5F, -29.2462F, 19.6296F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition Base_r8 = Joint2.addOrReplaceChild("Base_r8", CubeListBuilder.create().texOffs(53, 61).addBox(-2.0F, 21.8458F, -2.4497F, 4.0F, 7.0F, 3.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0F, -22.3593F, -3.8194F, 0.2007F, 0.0F, 0.0F));
