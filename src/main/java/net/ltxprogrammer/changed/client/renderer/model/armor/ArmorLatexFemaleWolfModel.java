...
public class ArmorLatexFemaleWolfModel<T extends LatexEntity> extends LatexHumanoidArmorModel<T, ArmorLatexFemaleWolfModel<T>> {
    ...
    private final LatexAnimator<T, ArmorLatexFemaleWolfModel<T>> animator;

    public ArmorLatexFemaleWolfModel(ModelPart modelPart) {
    ...
    @Override
    public LatexAnimator<T, ArmorLatexFemaleWolfModel<T>> getAnimator() {
        return animator;
    }
}
