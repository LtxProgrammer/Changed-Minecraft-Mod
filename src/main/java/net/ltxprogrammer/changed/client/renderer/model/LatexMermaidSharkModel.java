...
public class LatexMermaidSharkModel extends LatexHumanoidModel<LatexMermaidShark> implements LatexHumanoidModelInterface {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Base_r1 = Abdomen.addOrReplaceChild("Base_r1", CubeListBuilder.create().texOffs(0, 72).addBox(-4.5F, 3.3799F, -1.9097F, 9.0F, 1.0F, 1.0F, new CubeDeformation(0.35F))
                .texOffs(24, 0).addBox(-4.5F, -0.3201F, -1.9097F, 9.0F, 3.0F, 5.0F, new CubeDeformation(0.35F))
        ...
        PartDefinition Base_r4 = LowerAbdomen.addOrReplaceChild("Base_r4", CubeListBuilder.create().texOffs(27, 10).addBox(-4.5F, -0.6616F, -3.0281F, 9.0F, 1.0F, 6.0F, CubeDeformation.NONE)
                .texOffs(27, 72).addBox(-4.5F, -0.6616F, -3.0281F, 9.0F, 1.0F, 1.0F, CubeDeformation.NONE)
        ...
        PartDefinition Base_r5 = Tail.addOrReplaceChild("Base_r5", CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, -7.7475F, 0.2707F, 1.0F, 2.0F, 3.0F, CubeDeformation.NONE)
                .texOffs(13, 61).addBox(-1.0F, -5.7475F, 0.2707F, 2.0F, 8.0F, 3.0F, CubeDeformation.NONE)
                .texOffs(0, 37).addBox(-0.5F, -5.7475F, 3.2707F, 1.0F, 7.0F, 1.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 8.5418F, 4.7984F, -2.1817F, 0.0F, 0.0F));
        ...
        PartDefinition Base_r7 = Tail.addOrReplaceChild("Base_r7", CubeListBuilder.create().texOffs(55, 53).addBox(-2.5F, -6.132F, -4.4203F, 5.0F, 2.0F, 4.0F, new CubeDeformation(0.25F))
                .texOffs(57, 12).addBox(-2.0F, -5.0452F, -3.9279F, 4.0F, 5.0F, 3.0F, CubeDeformation.NONE)
                .texOffs(19, 41).addBox(-3.5F, -10.132F, -4.9203F, 7.0F, 4.0F, 5.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, 8.5418F, 4.7984F, 0.1745F, 0.0F, 0.0F));

        PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create(), PartPose.offset(0.0F, -2.0F, 0.0F));

        PartDefinition Snout_r1 = Head.addOrReplaceChild("Snout_r1", CubeListBuilder.create().texOffs(52, 66).addBox(0.0F, 0.0F, 0.0F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.005F)), PartPose.offsetAndRotation(-1.5F, -2.0F, -7.0F, 0.0F, -0.2182F, 0.0F));

        PartDefinition Snout_r2 = Head.addOrReplaceChild("Snout_r2", CubeListBuilder.create().texOffs(64, 66).addBox(-1.0F, 0.0F, 0.0F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.005F)), PartPose.offsetAndRotation(1.5F, -2.0F, -7.0F, 0.0F, 0.2182F, 0.0F));
        ...
        PartDefinition Hair = Head.addOrReplaceChild("Hair", CubeListBuilder.create().texOffs(0, 37).addBox(-2.0F, -33.0F, 3.0F, 4.0F, 1.0F, 8.0F, CubeDeformation.NONE)
                ...
                .texOffs(0, 62).addBox(2.0F, -32.95F, 7.0F, 2.0F, 1.0F, 4.0F, CubeDeformation.NONE)
                ...
                .texOffs(60, 20).addBox(-4.0F, -32.95F, 7.0F, 2.0F, 1.0F, 4.0F, CubeDeformation.NONE)
        ...
        PartDefinition Spike_r1 = RightArm.addOrReplaceChild("Spike_r1", CubeListBuilder.create().texOffs(0, 16).addBox(-0.5F, -2.75F, -2.0F, 1.0F, 5.0F, 2.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(-2.0789F, 4.8746F, 1.1151F, -2.6425F, 0.8346F, 3.1091F));
