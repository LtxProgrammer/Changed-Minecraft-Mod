...
public class LatexMermaidSharkModel extends LatexHumanoidModel<LatexMermaidShark> implements LatexHumanoidModelInterface {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Base_r4 = LowerAbdomen.addOrReplaceChild("Base_r4", CubeListBuilder.create().texOffs(27, 10).addBox(-4.5F, -0.6616F, -3.0281F, 9.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(27, 72).addBox(-4.5F, -0.6616F, -3.0281F, 9.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition Hair = Head.addOrReplaceChild("Hair", CubeListBuilder.create().texOffs(0, 37).addBox(-2.0F, -33.0F, 3.0F, 4.0F, 1.0F, 8.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 62).addBox(2.0F, -32.95F, 7.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(60, 20).addBox(-4.0F, -32.95F, 7.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition Spike_r1 = RightArm.addOrReplaceChild("Spike_r1", CubeListBuilder.create().texOffs(0, 16).addBox(-0.5F, -2.75F, -2.0F, 1.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0789F, 4.8746F, 1.1151F, -2.6425F, 0.8346F, 3.1091F));
