...
public class Legacy {
    ...
    public static LayerDefinition createMaleStandardHair() {
        ...
        PartDefinition Hair = partdefinition.addOrReplaceChild("Hair", CubeListBuilder.create().texOffs(16, 17).addBox(-2.0F, -8.0F, -4.0F, 4.0F, 1.0F, 8.0F, CubeDeformation.NONE)
                ...
                .texOffs(42, 17).addBox(-4.0F, -7.0F, 4.0F, 8.0F, 6.0F, 1.0F, CubeDeformation.NONE), PartPose.offset(0.0F, -1.5F, 0.0F));
    ...
    public static LayerDefinition createSideburnHairSHDD() {
        MeshDefinition meshdefinition = new MeshDefinition();
        PartDefinition partdefinition = meshdefinition.getRoot();
        ...
        PartDefinition Hair = partdefinition.addOrReplaceChild("Hair", CubeListBuilder.create().texOffs(16, 17).addBox(-2.0F, -8.0F, -4.0F, 4.0F, 1.0F, 8.0F, CubeDeformation.NONE)
                ...
                .texOffs(42, 17).addBox(-4.0F, -7.0F, 4.0F, 8.0F, 6.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(29, 74).addBox(2.25F, -5.0F, -3.0F, 2.0F, 4.0F, 5.0F, CubeDeformation.NONE)
                .texOffs(0, 67).addBox(-4.25F, -5.0F, -3.0F, 2.0F, 4.0F, 5.0F, CubeDeformation.NONE), PartPose.offset(0.0F, -1.5F, 0.0F));

        return LayerDefinition.create(meshdefinition, 128, 128);
    }

    public static LayerDefinition createFemaleTripleBangsHairSHDD() {
        MeshDefinition meshdefinition = new MeshDefinition();
        PartDefinition partdefinition = meshdefinition.getRoot();
    ...
    public static LayerDefinition createShortFrontHairSHDD() {
        MeshDefinition meshdefinition = new MeshDefinition();
        PartDefinition partdefinition = meshdefinition.getRoot();
