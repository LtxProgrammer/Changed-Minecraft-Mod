...
public class Legacy {
    ...
    public static LayerDefinition createMohawkHair() {
        ...
        PartDefinition Hair = partdefinition.addOrReplaceChild("Hair", CubeListBuilder.create().texOffs(0, 16).addBox(-2.0F, -9.75F, -3.75F, 4.0F, 2.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(24, 0).addBox(2.0F, -9.25F, -3.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.025F))
                .texOffs(4, 0).addBox(-3.0F, -9.0F, 3.25F, 1.0F, 5.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(16, 16).addBox(-3.0F, -9.25F, -3.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.025F))
                .texOffs(0, 0).addBox(2.0F, -9.0F, 3.25F, 1.0F, 5.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(23, 24).addBox(-2.0F, -9.025F, 3.75F, 4.0F, 7.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(0, 25).addBox(-2.0F, -9.25F, -4.25F, 4.0F, 1.0F, 1.0F, CubeDeformation.NONE), PartPose.offset(0.0F, 1.0F, 0.0F));
    ...
    public static LayerDefinition createHeadFuzzHair() {
        ...
        PartDefinition Hair = partdefinition.addOrReplaceChild("Hair", CubeListBuilder.create().texOffs(0, 16).addBox(-2.0F, -9.75F, -17.5F, 4.0F, 1.0F, 6.0F, CubeDeformation.NONE)
                .texOffs(14, 16).addBox(-3.5F, -9.5F, -18.5F, 7.0F, 1.0F, 3.0F, CubeDeformation.NONE)
                .texOffs(0, 23).addBox(1.5F, -9.75F, -15.5F, 2.0F, 1.0F, 4.0F, CubeDeformation.NONE)
                .texOffs(16, 20).addBox(-3.5F, -9.75F, -15.5F, 2.0F, 1.0F, 4.0F, CubeDeformation.NONE), PartPose.offset(0.0F, 1.0F, 0.0F));
    ...
    public static LayerDefinition createMaleStandardHair() {
        ...
        PartDefinition Hair = partdefinition.addOrReplaceChild("Hair", CubeListBuilder.create().texOffs(0, 16).addBox(-2.0F, -5.0F, -4.0F, 9.0F, 1.0F, 8.0F, CubeDeformation.NONE)
                .texOffs(24, 0).addBox(-4.0F, -4.5F, -3.5F, 8.0F, 1.0F, 3.0F, CubeDeformation.NONE)
                .texOffs(32, 8).addBox(2.0F, -4.95F, 0.0F, 2.0F, 1.0F, 4.0F, CubeDeformation.NONE)
                .texOffs(0, 25).addBox(2.5F, -4.0F, -4.0F, 2.0F, 3.0F, 8.0F, new CubeDeformation(0.025F))
                .texOffs(24, 6).addBox(-3.5F, -3.0F, -4.25F, 7.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(0, 3).addBox(3.5F, -4.0F, -4.5F, 1.0F, 2.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(0, 0).addBox(-4.5F, -4.0F, -4.5F, 1.0F, 2.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(29, 30).addBox(2.5F, -1.0F, -1.0F, 2.0F, 2.0F, 5.0F, CubeDeformation.NONE)
                .texOffs(20, 28).addBox(-4.5F, -1.0F, -1.0F, 2.0F, 2.0F, 5.0F, CubeDeformation.NONE)
                .texOffs(16, 17).addBox(-4.5F, -4.0F, -4.0F, 2.0F, 3.0F, 8.0F, new CubeDeformation(0.025F))
                .texOffs(12, 28).addBox(-4.0F, -4.95F, 0.0F, 2.0F, 1.0F, 4.0F, CubeDeformation.NONE)
                .texOffs(24, 4).addBox(-4.0F, -4.0F, -4.5F, 8.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                .texOffs(28, 16).addBox(-4.0F, -4.0F, 4.0F, 8.0F, 6.0F, 1.0F, CubeDeformation.NONE), PartPose.offset(0.0F, 1.0F, 0.0F));
