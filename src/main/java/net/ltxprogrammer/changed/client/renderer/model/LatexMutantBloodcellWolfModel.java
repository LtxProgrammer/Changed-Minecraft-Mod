...
public class LatexMutantBloodcellWolfModel extends AdvancedHumanoidModel<LatexMutantBloodcellWolf> implements AdvancedHumanoidModelInterface<LatexMutantBloodcellWolf, LatexMutantBloodcellWolfModel> {
    ...
    @Override
    public void prepareMobModel(LatexMutantBloodcellWolf p_102861_, float p_102862_, float p_102863_, float p_102864_) {
    ...
    @Override
    public void setupAnim(@NotNull LatexMutantBloodcellWolf entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
