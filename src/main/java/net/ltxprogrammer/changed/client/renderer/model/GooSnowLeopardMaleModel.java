...
public class GooSnowLeopardMaleModel extends AdvancedHumanoidModel<GooSnowLeopardMale> implements AdvancedHumanoidModelInterface<GooSnowLeopardMale, GooSnowLeopardMaleModel> {
    ...
    private final HumanoidAnimator<GooSnowLeopardMale, GooSnowLeopardMaleModel> animator;

    public GooSnowLeopardMaleModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(GooSnowLeopardMale p_102861_, float p_102862_, float p_102863_, float p_102864_) {
    ...
    @Override
    public void setupAnim(@NotNull GooSnowLeopardMale entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<GooSnowLeopardMale, GooSnowLeopardMaleModel> getAnimator() {
        return animator;
    }
}
