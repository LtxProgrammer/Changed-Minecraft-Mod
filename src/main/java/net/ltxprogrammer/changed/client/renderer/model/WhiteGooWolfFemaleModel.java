...
public class WhiteGooWolfFemaleModel extends AdvancedHumanoidModel<WhiteGooWolfFemale> implements AdvancedHumanoidModelInterface<WhiteGooWolfFemale, WhiteGooWolfFemaleModel> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Changed.modResource("white_goo_wolf_female"), "main");
    ...
    private final HumanoidAnimator<WhiteGooWolfFemale, WhiteGooWolfFemaleModel> animator;

    public WhiteGooWolfFemaleModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(WhiteGooWolfFemale p_102861_, float p_102862_, float p_102863_, float p_102864_) {
    ...
    @Override
    public void setupAnim(@NotNull WhiteGooWolfFemale entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<WhiteGooWolfFemale, WhiteGooWolfFemaleModel> getAnimator() {
        return animator;
    }
}
