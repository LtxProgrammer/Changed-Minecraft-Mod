...
@OnlyIn(Dist.CLIENT)
public class GooDeerModel extends AdvancedHumanoidModel<LatexDeer> implements AdvancedHumanoidModelInterface<LatexDeer, GooDeerModel> {
    ...
    private final HumanoidAnimator<LatexDeer, GooDeerModel> animator;

    public GooDeerModel(ModelPart root) {
        super(root);
    ...
    @Override
    public HumanoidAnimator<LatexDeer, GooDeerModel> getAnimator() {
        return animator;
    }
}